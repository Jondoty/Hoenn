...
#Tests for the player's game version and chosen rival
execute as @e[x=-2070,y=64,z=1414,dx=2,dy=5,type=armor_stand] run data merge entity @s {CustomName:'{"text":"Pixelmon Hoenn"}'}
execute as @s[scores={GameVersion=0}] as @e[x=-2070,y=64,z=1414,dy=5,type=armor_stand] run data merge entity @s {CustomName:'{"text":"No game version","color":"gray"}'}
...
execute as @s[scores={Rival=0}] as @e[x=-2068,y=64,z=1414,dy=5,type=armor_stand] run data merge entity @s {CustomName:'{"text":"No rival","color":"gray"}'}
...
tellraw @s ["",{"text":"5) ["},{"selector":"@e[x=-2070,y=64,z=1414,dy=5,type=armor_stand]"},{"text":"] ["},{"selector":"@e[x=-2068,y=64,z=1414,dy=5,type=armor_stand]"},{"text":"] ["},{"text":"Info","hoverEvent":{"action":"show_text","contents":"Lists which game version or rival you picked (or have yet to pick) to help narrow down specifics of a story-driven issue."}},{"text":"]"}]
