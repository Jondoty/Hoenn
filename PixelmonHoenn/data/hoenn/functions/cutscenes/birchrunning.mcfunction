...
execute as @e[x=-2070,y=65,z=1410,dy=3,tag=!Birch1Initiate] run tp @e[type=pixelmon:npc_chatting,x=-2054,y=68,z=217,dx=20,dy=10,dz=15] 10000000 -50000 -10000000
