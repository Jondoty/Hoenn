...
execute as @a[x=-2123,y=63,z=1286,dx=203,dy=40,dz=50,nbt={Inventory:[{id:"pixelmon:pixelmon_sprite",tag:{ndex:501}}]},scores={TriggerCommand=0}] run scoreboard players set @s TriggerCommand 58
