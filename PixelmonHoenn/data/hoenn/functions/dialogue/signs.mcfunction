...
-2735 69 -380
There are pairs of Trainers who challenge others for two-on-two Pokémon battles called Double Battles.
In a Double Battle, the Trainers must send out two Pokémon, the ones at the top of their list.
Pay attention to how you array the Pokémon in your list!
...
As soon as a battle starts, switch it out. It will earn Exp. Points without being exposed to any harm.

-2796 69 -299
In addition to Hit Points (HP), Pokémon have Power Points (PP) that are used to make moves during battle.
If a Pokémon runs out of PP, it must be taken to a Pokémon Center.
...
Time-saving tunnel nearing completion!

"Time-saving tunnel nearing completion!"
That's what it says on the sign, but there's also a big "X" splashed across it in red paint...
...
-2550 69 -706
If you want to stop a Pokémon from evolving, press the cancel button while it is trying to evolve.
The startled Pokémon will stop. This is called an Evolution cancel.

-2495 68 -715
Multiple bags can act as several Pockets.
Items you obtain can be sorted into different bags for organization.
No Trainer can afford to be without a Bag.
...
Note: The tunnel project has been canceled.
