...
tellraw @s[scores={DialogueTrigger=15,TalkTime=1}] ["",{"text":"<May> How's it going, "},{"selector":"@s"},{"text":"?"}]
tellraw @s[scores={DialogueTrigger=15,TalkTime=1}] {"text":"<May> Have you been using your DexNav and perfecting your sneaking skills?"}
...
tellraw @s[scores={DialogueTrigger=15,TalkTime=1}] {"text":"<May> Ah!"}
tellraw @s[scores={DialogueTrigger=15,TalkTime=1}] ["",{"text":"<May> Look! Up there! Check 'em out, "},{"selector":"@s"},{"text":"!"}]
tellraw @s[scores={DialogueTrigger=15,TalkTime=1}] {"text":"<May> Those were...Beautifly, weren't they?"}
tellraw @s[scores={DialogueTrigger=15,TalkTime=1}] {"text":"<May> I'll have to check in my DexNav later to be sure!"}
tellraw @s[scores={DialogueTrigger=15,TalkTime=1}] {"text":"<May> Oh, l-look! There's Petalburg already!"}
tellraw @s[scores={DialogueTrigger=15,TalkTime=1}] ["",{"text":"<May> "},{"selector":"@s"},{"text":", your dad... He's the Gym Leader in Petalburg City, isn't he?"}]
tellraw @s[scores={DialogueTrigger=15,TalkTime=1}] {"text":"<May> Maybe I should try to take him on myself, once I train up my Pokémon a bit more!"}
tellraw @s[scores={DialogueTrigger=15,TalkTime=1}] ["",{"text":"<May> Guess I'm off then, "},{"selector":"@s"},{"text":"! Let's meet up again sometime!"}]


tellraw @s[scores={DialogueTrigger=15,TalkTime=1}] ["",{"text":"<Brendan> How's it going, "},{"selector":"@s"},{"text":"?"}]
tellraw @s[scores={DialogueTrigger=15,TalkTime=1}] {"text":"<Brendan> Have you been using your DexNav and perfecting your sneaking skills?"}
...
tellraw @s[scores={DialogueTrigger=15,TalkTime=1}] {"text":"<Brendan> Ah!"}
tellraw @s[scores={DialogueTrigger=15,TalkTime=1}] ["",{"text":"<Brendan> Look! Up there! Check 'em out, "},{"selector":"@s"},{"text":"!"}]
tellraw @s[scores={DialogueTrigger=15,TalkTime=1}] {"text":"<Brendan> Those were...Beautifly, weren't they?"}
tellraw @s[scores={DialogueTrigger=15,TalkTime=1}] {"text":"<Brendan> I'll have to check in my DexNav later to be sure!"}
tellraw @s[scores={DialogueTrigger=15,TalkTime=1}] {"text":"<Brendan> Oh, l-look! There's Petalburg already!"}
tellraw @s[scores={DialogueTrigger=15,TalkTime=1}] ["",{"text":"<Brendan> "},{"selector":"@s"},{"text":", your dad... He's the Gym Leader in Petalburg City, isn't he?"}]
...
tellraw @s[scores={DialogueTrigger=16,TalkTime=1}] {"text":"<Youngster> Th-thank you, sir!"}

tellraw @s[scores={DialogueTrigger=16,TalkTime=1}] {"text":"<Dad> Come back and challenge me again anytime."}
tellraw @s[scores={DialogueTrigger=16,TalkTime=1}] {"text":"<Dad> I'll be looking forward to seeing you and your Pokémon again when you're a bit stronger."}

tellraw @s[scores={DialogueTrigger=16,TalkTime=1}] {"text":"<Youngster> Yes, sir! Thank you, sir! I'm gonna do special training with my Pokémon."}
tellraw @s[scores={DialogueTrigger=16,TalkTime=1}] {"text":"<Youngster> Then I'll challenge this Gym again!"}
tellraw @s[scores={DialogueTrigger=16,TalkTime=1}] {"text":"<Youngster> Thank you for the battle, Mr. Norman!"}

#kid tp out

tellraw @s[scores={DialogueTrigger=16,TalkTime=1}] {"text":"<Dad> Hm?"}
tellraw @s[scores={DialogueTrigger=16,TalkTime=1}] ["",{"text":"<Dad> Why, if it isn't "},{"selector":"@s"},{"text":"!"}]
tellraw @s[scores={DialogueTrigger=16,TalkTime=1}] {"text":"<Dad> So you've finished moving in?"}
tellraw @s[scores={DialogueTrigger=16,TalkTime=1}] {"text":"<Dad> I see... Well..."}
tellraw @s[scores={DialogueTrigger=16,TalkTime=1}] {"text":"<Dad> I guess we shouldn't stand around out here talking."}
tellraw @s[scores={DialogueTrigger=16,TalkTime=1}] {"text":"<Dad> Do you want to come in for a bit? We can talk in the Gym."}

#tp both into gym entrance room

tellraw @s[scores={DialogueTrigger=16,TalkTime=1}] {"text":"<Dad> You know, I sure was surprised that you managed to get here by yourself."}
tellraw @s[scores={DialogueTrigger=16,TalkTime=1}] {"text":"<Dad> Ah... I see."}
tellraw @s[scores={DialogueTrigger=16,TalkTime=1}] {"text":"<Dad> You're making a good start on your team!"}
tellraw @s[scores={DialogueTrigger=16,TalkTime=1}] ["",{"text":"<Dad> Mm-hmm! Then I guess you're going to become a Trainer like me, "},{"selector":"@s"},{"text":"?"}]
tellraw @s[scores={DialogueTrigger=16,TalkTime=1}] {"text":"<Dad> Now that's something to look forward to!"}

tellraw @s[scores={DialogueTrigger=16,TalkTime=1}] {"text":"<...> Um... E-excuse me..."}
tellraw @s[scores={DialogueTrigger=16,TalkTime=1}] {"text":"<...> I...I'd like to get a Pokémon, please..."}

#Wally teleports in

tellraw @s[scores={DialogueTrigger=16,TalkTime=1}] {"text":"<Dad> Hm? Aren't you... You're Wally, right?"}

tellraw @s[scores={DialogueTrigger=16,TalkTime=1}] {"text":"<Wally> Y-yes... I'm supposed to go stay with my relatives in Verdanturf Town for a while."}
tellraw @s[scores={DialogueTrigger=16,TalkTime=1}] {"text":"<Wally> But I thought I might be lonely by myself, so I wanted to bring a Pokémon with me."}
tellraw @s[scores={DialogueTrigger=16,TalkTime=1}] {"text":"<Wally> But I've never caught a Pokémon by myself..."}
tellraw @s[scores={DialogueTrigger=16,TalkTime=1}] {"text":"<Wally> I'm not sure if I can."}

tellraw @s[scores={DialogueTrigger=16,TalkTime=1}] {"text":"<Dad> Mm-hmm. I see."}
tellraw @s[scores={DialogueTrigger=16,TalkTime=1}] ["",{"text":"<Dad> "},{"selector":"@s"},{"text":"! You heard all that, right?"}]
tellraw @s[scores={DialogueTrigger=16,TalkTime=1}] {"text":"<Dad> You go with Wally, and make sure that he safely catches a Pokémon."}
tellraw @s[scores={DialogueTrigger=16,TalkTime=1}] {"text":"<Dad> Wally, here. I'll lend you one of my Pokémon."}

tellraw @s[scores={DialogueTrigger=16,TalkTime=1}] {"text":"Wally received Zigzagoon!","italic":true,"color":"gray"}

tellraw @s[scores={DialogueTrigger=16,TalkTime=1}] {"text":"<Wally> Oh, wow... Your Pokémon, sir?"}

tellraw @s[scores={DialogueTrigger=16,TalkTime=1}] {"text":"<Dad> Hmm... I'll give you a Poké Ball, too, so go give it your best!"}

tellraw @s[scores={DialogueTrigger=16,TalkTime=1}] {"text":"Wally received a Poké Ball!","italic":true,"color":"gray"}

tellraw @s[scores={DialogueTrigger=16,TalkTime=1}] {"text":"<Wally> Th-thank you, Mr. Norman!"}
tellraw @s[scores={DialogueTrigger=16,TalkTime=1}] ["",{"text":"<Wally> Um..."},{"selector":"@s"},{"text":"? You will... You will come with me, right?"}]

#teleports both to route sequence

#Route 102

tellraw @s[scores={DialogueTrigger=16,TalkTime=1}] ["",{"text":"<Wally> "},{"selector":"@s"},{"text":"... Pokémon hide in tall grass like this, don't they?"}]
tellraw @s[scores={DialogueTrigger=16,TalkTime=1}] {"text":"<Wally> P-please stay there to watch and see if I can catch one properly."}

#exclamation
tellraw @s[scores={DialogueTrigger=16,TalkTime=1}] {"text":"<Wally> Wh-whoa!"}

#Spawns a Ralts statue

#Spawns Zigzagoon statue facing Ralts

tellraw @s[scores={DialogueTrigger=16,TalkTime=1}] {"text":"<Wally> I'm su-supposed to try to weaken the Pokémon before I throw my Poké Ball, right? I read that in a book recently."}


tellraw @s[scores={DialogueTrigger=16,TalkTime=1}] {"text":"Wally used a Poké Ball!","italic":true,"color":"gray"}
#Wally throws a Pokeball at Ralts, catches

tellraw @s[scores={DialogueTrigger=16,TalkTime=1}] {"text":"Gotcha! Ralts was caught!","italic":true,"color":"gray"}

tellraw @s[scores={DialogueTrigger=16,TalkTime=1}] {"text":"<Wally> I did it... It's my... My own Pokémon!"}
tellraw @s[scores={DialogueTrigger=16,TalkTime=1}] ["",{"text":"<Wally> Thanks so much, "},{"selector":"@s"},{"text":"! Let's head back to the Gym!"}]

#tp back to Gym

tellraw @s[scores={DialogueTrigger=16,TalkTime=1}] {"text":"<Dad> So did it go well?"}

tellraw @s[scores={DialogueTrigger=16,TalkTime=1}] {"text":"<Wally> Yes, it did! Thank you!"}
tellraw @s[scores={DialogueTrigger=16,TalkTime=1}] {"text":"<Wally> Let me give you back your Pokémon, sir."}
tellraw @s[scores={DialogueTrigger=16,TalkTime=1}] ["",{"text":"<Wally> And you, "},{"selector":"@s"},{"text":"... Thank you so much for coming with me."}]
tellraw @s[scores={DialogueTrigger=16,TalkTime=1}] {"text":"<Wally> It was all thanks to you two that I was able to catch Ralts."}
tellraw @s[scores={DialogueTrigger=16,TalkTime=1}] {"text":"<Wally> My very own Ralts..."}
tellraw @s[scores={DialogueTrigger=16,TalkTime=1}] {"text":"<Wally> I will always, always treasure it!"}
tellraw @s[scores={DialogueTrigger=16,TalkTime=1}] {"text":"<Wally> I'm going to try my best together with Ralts."}
tellraw @s[scores={DialogueTrigger=16,TalkTime=1}] ["",{"text":"<Wally> You do your best, too, "},{"selector":"@s"},{"text":"!"}]
tellraw @s[scores={DialogueTrigger=16,TalkTime=1}] {"text":"<Wally> Oh, but my mom's waiting for me. I've got to get going!"}
tellraw @s[scores={DialogueTrigger=16,TalkTime=1}] ["",{"text":"<Wally> I hope we'll meet again, "},{"selector":"@s"},{"text":"! And you, too, Mr. Norman!"}]

#Wally teleports out

tellraw @s[scores={DialogueTrigger=16,TalkTime=1}] {"text":"<Dad> Hmm. That boy will be worth keeping an eye on. But for now..."}
tellraw @s[scores={DialogueTrigger=16,TalkTime=1}] ["",{"text":"<Dad> "},{"selector":"@s"},{"text":"!"}]
tellraw @s[scores={DialogueTrigger=16,TalkTime=1}] {"text":"<Dad> If you want to become strong as a Trainer, listen to my advice."}
tellraw @s[scores={DialogueTrigger=16,TalkTime=1}] {"text":"<Dad> First head for Rustboro City, which lies beyond this town."}
tellraw @s[scores={DialogueTrigger=16,TalkTime=1}] {"text":"<Dad> There you should challenge the Gym Leader, Roxanne."}
tellraw @s[scores={DialogueTrigger=16,TalkTime=1}] {"text":"<Dad> After her, go on to the other Pokémon Gyms and defeat their Leaders as well."}
tellraw @s[scores={DialogueTrigger=16,TalkTime=1}] {"text":"<Dad> Collect Badges from them, understand?"}
...
tellraw @s[scores={DialogueTrigger=17,TalkTime=1}] {"text":"<Researcher> Hello, have you seen any Pokémon called Shroomish around here?"}
tellraw @s[scores={DialogueTrigger=17,TalkTime=1}] {"text":"<Researcher> I really love that Pokémon."}

#Team Grunt teleports in

#Red
tellraw @s[scores={DialogueTrigger=17,TalkTime=1}] {"text":"<...> I was going to ambush you, but you had to dawdle in Petalburg Woods forever, didn't you?"}
tellraw @s[scores={DialogueTrigger=17,TalkTime=1}] {"text":"<...> I got sick of waiting, so here I am!"}
tellraw @s[scores={DialogueTrigger=17,TalkTime=1}] {"text":"<...> You! Devon researcher! Hand over those papers!"}
...
tellraw @s[scores={DialogueTrigger=17,TalkTime=1}] {"text":"<Researcher> Aiyeeeh! You're a Pokémon Trainer, aren't you?"}
tellraw @s[scores={DialogueTrigger=17,TalkTime=1}] {"text":"<Researcher> You've got to help me, please!"}

#Magma Line
tellraw @s[scores={DialogueTrigger=17,TalkTime=1}] {"text":"<...> Hunh? What do you think you're doing?"}
tellraw @s[scores={DialogueTrigger=17,TalkTime=1}] {"text":"<...> What, you're going to protect him?"}
tellraw @s[scores={DialogueTrigger=17,TalkTime=1}] {"text":"<...> No one who crosses Team Magma gets any mercy, not even a kid!"}
...
#Aqua Line
tellraw @s[scores={DialogueTrigger=18,TalkTime=1}] {"text":"<Team Aqua Grunt> Grrr... You've got some nerve meddling with Team Aqua!"}
tellraw @s[scores={DialogueTrigger=18,TalkTime=1}] {"text":"<Team Aqua Grunt> Come on and battle me again!"}
tellraw @s[scores={DialogueTrigger=18,TalkTime=1}] {"text":"<Team Aqua Grunt> I wish I could say that, but I'm out of Pokémon..."}
tellraw @s[scores={DialogueTrigger=18,TalkTime=1}] {"text":"<Team Aqua Grunt> And, hey, we of Team Aqua are also after something in Rustboro."}
tellraw @s[scores={DialogueTrigger=18,TalkTime=1}] {"text":"<Team Aqua Grunt> I'll let you go for today!"}

#teleports out

#Magma line
tellraw @s[scores={DialogueTrigger=18,TalkTime=1}] {"text":"<Team Magma Grunt> Grrr... You've got some nerve meddling with Team Magma!"}
tellraw @s[scores={DialogueTrigger=18,TalkTime=1}] {"text":"<Team Magma Grunt> Come on and battle me again!"}
tellraw @s[scores={DialogueTrigger=18,TalkTime=1}] {"text":"<Team Magma Grunt> I wish I could say that, but I'm out of Pokémon..."}
tellraw @s[scores={DialogueTrigger=18,TalkTime=1}] {"text":"<Team Magma Grunt> And, hey, we of Team Magma are also after something in Rustboro."}
tellraw @s[scores={DialogueTrigger=18,TalkTime=1}] {"text":"<Team Magma Grunt> I'll let you go for today!"}

#teleports out

tellraw @s[scores={DialogueTrigger=18,TalkTime=1}] {"text":"<Researcher> Whew... That was awfully close!"}
tellraw @s[scores={DialogueTrigger=18,TalkTime=1}] {"text":"<Researcher> Thanks to you, he didn't rob me of these important papers."}
tellraw @s[scores={DialogueTrigger=18,TalkTime=1}] {"text":"<Researcher> I know! I'll give you this as my thanks!"}

tellraw @s[scores={DialogueTrigger=18,TalkTime=1}] ["",{"selector":"@s","italic":true,"color":"gray"},{"text":" obtained the Exp. All!","italic":true,"color":"gray"}]

tellraw @s[scores={DialogueTrigger=18,TalkTime=1}] {"text":"<Researcher> The Exp. Share is a super high-tech device."}
tellraw @s[scores={DialogueTrigger=18,TalkTime=1}] {"text":"<Researcher> I had to strain every fiber of my brain and body to develop this device!"}
tellraw @s[scores={DialogueTrigger=18,TalkTime=1}] {"text":"<Researcher> Right click the device, and battle experience will be shared by all party Pokémon!"}
tellraw @s[scores={DialogueTrigger=18,TalkTime=1}] {"text":"<Researcher> Please give it a try!"}
tellraw @s[scores={DialogueTrigger=18,TalkTime=1}] {"text":"<Researcher> And with this, I'll restore your Pokémon's health."}
tellraw @s[scores={DialogueTrigger=18,TalkTime=1}] {"text":"<Researcher> It's another technical advance that I'm proud of!"}

execute as @s[scores={DialogueTrigger=18,TalkTime=1}] run pokeheal
tellraw @s[scores={DialogueTrigger=18,TalkTime=1}] {"text":"You had your Pokémon's HP restored!","italic":true,"color":"gray"}

tellraw @s[scores={DialogueTrigger=18,TalkTime=1}] {"text":"<Researcher> ...Ah! Didn't that Team Aqua thug say they were after something in Rustboro, too?"}
tellraw @s[scores={DialogueTrigger=18,TalkTime=1}] {"text":"<Researcher> ...Ah! Didn't that Team Magma thug say they were after something in Rustboro, too?"}

tellraw @s[scores={DialogueTrigger=18,TalkTime=1}] {"text":"<Researcher> Uh-oh! It's a crisis! I can't be wasting time!"}
...
tellraw @s[scores={DialogueTrigger=20,TalkTime=1}] ["",{"text":"<May> So you made it here to Rustboro, too, "},{"selector":"@s"},{"text":"."}]

execute as @s[scores={DialogueTrigger=20,TalkTime=1}] run tp @s -2650 122 -534 154 32
tellraw @s[scores={DialogueTrigger=20,TalkTime=1}] {"text":"<May> It's really big here, isn't it? Littleroot can't even compare."}

execute as @s[scores={DialogueTrigger=20,TalkTime=1}] run tp @s -2687 87 -656 -144 28
tellraw @s[scores={DialogueTrigger=20,TalkTime=1}] ["",{"text":"<May> Oh, and "},{"selector":"@s"},{"text":", have you heard? There's a Pokémon Gym here, too!"}]




tellraw @s[scores={DialogueTrigger=20,TalkTime=1}] ["",{"text":"<Brendan> So you made it here to Rustboro, too, "},{"selector":"@s"},{"text":"."}]
execute as @s[scores={DialogueTrigger=20,TalkTime=1}] run tp @s -2650 122 -534 154 32
tellraw @s[scores={DialogueTrigger=20,TalkTime=1}] {"text":"<Brendan> It's a real city, huh? Nothing like Littleroot."}

execute as @s[scores={DialogueTrigger=20,TalkTime=1}] run tp @s -2687 87 -656 -144 28
tellraw @s[scores={DialogueTrigger=20,TalkTime=1}] {"text":"<Brendan> Oh, did you know? There's a Pokémon Gym here, too."}


execute as @s[scores={DialogueTrigger=20,TalkTime=1}] run tp @s -2741 69 -561 180 ~

tellraw @s[scores={DialogueTrigger=20,TalkTime=1}] {"text":"<May> Once I catch a couple more Pokémon, I'll be sure to take it on with my team! See you later!"}
tellraw @s[scores={DialogueTrigger=20,TalkTime=1}] {"text":"<Brendan> Soon as I gather a few more Pokémon, I'll be trying my team against it! See ya!"}
...
tellraw @s[scores={DialogueTrigger=26,TalkTime=1}] {"text":"Out of the way! Move it!","bold":true}

#Grunt runs out of town

tellraw @s[scores={DialogueTrigger=26,TalkTime=1}] {"text":"<Researcher> Wait! Pleeeaaase!"}
tellraw @s[scores={DialogueTrigger=26,TalkTime=1}] {"text":"<Researcher> Don't take those parts!"}
...
tellraw @s[scores={DialogueTrigger=27,TalkTime=1}] {"text":"<Researcher> Oh, you there! You're that fantastic Trainer who helped me in Petalburg Woods!"}

tellraw @s[scores={DialogueTrigger=27,TalkTime=1}] {"text":"<Researcher> Help me! I was robbed by Team Aqua! I have to get the Devon Parts back!"}
tellraw @s[scores={DialogueTrigger=27,TalkTime=1}] {"text":"<Researcher> Help me! I was robbed by Team Magma! I have to get the Devon Parts back!"}
...
tellraw @s[scores={DialogueTrigger=28,TalkTime=1}] {"text":"<Team Magma Grunt> Grah, keelhaul it all!"}
tellraw @s[scores={DialogueTrigger=28,TalkTime=1}] {"text":"<Team Magma Grunt> This hostage Pokémon turned out to be worthless!"}
tellraw @s[scores={DialogueTrigger=28,TalkTime=1}] {"text":"<Team Magma Grunt> And to think I made a getaway... into this tunnel to nowhere!"}
tellraw @s[scores={DialogueTrigger=28,TalkTime=1}] {"text":"<Team Magma Grunt> And you! Now you're here to battle me. Really?"}

tellraw @s[scores={DialogueTrigger=28,TalkTime=1}] {"text":"<Team Aqua Grunt> Grah, keelhaul it all!"}
tellraw @s[scores={DialogueTrigger=28,TalkTime=1}] {"text":"<Team Aqua Grunt> This hostage Pokémon turned out to be worthless!"}
tellraw @s[scores={DialogueTrigger=28,TalkTime=1}] {"text":"<Team Aqua Grunt> And to think I made a getaway... into this tunnel to nowhere!"}
tellraw @s[scores={DialogueTrigger=28,TalkTime=1}] {"text":"<Team Aqua Grunt> And you! Now you're here to battle me. Really?"}
...
tellraw @s[scores={DialogueTrigger=29,TalkTime=1}] {"text":"<Team Magma Grunt> This is plain not right..."}
tellraw @s[scores={DialogueTrigger=29,TalkTime=1}] {"text":"<Team Magma Grunt> The boss told me this would be a slick-and-easy job to pull."}
tellraw @s[scores={DialogueTrigger=29,TalkTime=1}] {"text":"<Team Magma Grunt> All I had to do was steal some parts from Devon."}
tellraw @s[scores={DialogueTrigger=29,TalkTime=1}] {"text":"<Team Magma Grunt> Tch! You want 'em back that badly, then take 'em!"}

tellraw @s[scores={DialogueTrigger=29,TalkTime=1}] {"text":"<Team Aqua Grunt> This is plain not right..."}
tellraw @s[scores={DialogueTrigger=29,TalkTime=1}] {"text":"<Team Aqua Grunt> The boss told me this would be a slick-and-easy job to pull."}
tellraw @s[scores={DialogueTrigger=29,TalkTime=1}] {"text":"<Team Aqua Grunt> All I had to do was steal some parts from Devon."}
tellraw @s[scores={DialogueTrigger=29,TalkTime=1}] {"text":"<Team Aqua Grunt> Tch! You want 'em back that badly, then take 'em!"}

tellraw @s[scores={DialogueTrigger=29,TalkTime=1}] ["",{"selector":"@s","italic":true,"color":"gray"},{"text":" obtained the Devon Parts!","italic":true,"color":"gray"}]
...
tellraw @s[scores={DialogueTrigger=61,TalkTime=1}] {"text":"<Wally> I want to challenge this Gym to see how much stronger I've become!"}
tellraw @s[scores={DialogueTrigger=61,TalkTime=1}] {"text":"<Wally> Please! You'll let me, won't you?"}

tellraw @s[scores={DialogueTrigger=61,TalkTime=1}] {"text":"<Wally's Uncle> Now hold on, Wally..."}
tellraw @s[scores={DialogueTrigger=61,TalkTime=1}] {"text":"<Wally's Uncle> It's certainly true that you've grown quite a lot stronger alongside your Pokémon."}
tellraw @s[scores={DialogueTrigger=61,TalkTime=1}] {"text":"<Wally's Uncle> But don't you think that jumping right into challenging a Gym might be pushing it?"}

tellraw @s[scores={DialogueTrigger=61,TalkTime=1}] {"text":"<Wally> I'm not pushing it! If it's me and my Ralts, we can beat anyone!"}
tellraw @s[scores={DialogueTrigger=61,TalkTime=1}] ["",{"text":"<Wally> Ah! "},{"selector":"@s"},{"text":"!"}]
tellraw @s[scores={DialogueTrigger=61,TalkTime=1}] {"text":"<Wally> Ralts and I have gotten a lot stronger since we first met. Growing together!"}
...
tellraw @s[scores={DialogueTrigger=62,TalkTime=1}] {"text":"<Wally> ... I'll go back to Verdanturf..."}
tellraw @s[scores={DialogueTrigger=62,TalkTime=1}] ["",{"text":"<Wally> "},{"selector":"@s"},{"text":", thank you... Being a Trainer is tough, isn't it?"}]
tellraw @s[scores={DialogueTrigger=62,TalkTime=1}] {"text":"<Wally> It's not enough just to battle with your Pokémon."}
tellraw @s[scores={DialogueTrigger=62,TalkTime=1}] {"text":"<Wally> I can't become a true Trainer like that... Not really..."}

tellraw @s[scores={DialogueTrigger=62,TalkTime=1}] {"text":"<Wally's Uncle> Wally, there's no need to get so down on yourself."}
tellraw @s[scores={DialogueTrigger=62,TalkTime=1}] {"text":"<Wally's Uncle> Why, what's keeping you from becoming stronger?"}
tellraw @s[scores={DialogueTrigger=62,TalkTime=1}] {"text":"<Wally's Uncle> Nothing is! All you need to do is keep growing."}

tellraw @s[scores={DialogueTrigger=62,TalkTime=1}] {"text":"<Wally> ..."}

tellraw @s[scores={DialogueTrigger=62,TalkTime=1}] {"text":"<Wally's Uncle> Come on, let's go home. Everyone's waiting for you."}

tellraw @s[scores={DialogueTrigger=62,TalkTime=1}] {"text":"<Wally> ...Yes, Uncle."}
tellraw @s[scores={DialogueTrigger=62,TalkTime=1}] ["",{"text":"<Wally> "},{"selector":"@s"},{"text":"..."}]
tellraw @s[scores={DialogueTrigger=62,TalkTime=1}] {"text":"<Wally> I... I'm definitely... I'm going to get stronger. Much, much stronger!"}
tellraw @s[scores={DialogueTrigger=62,TalkTime=1}] {"text":"<Wally> I feel like I learned a lot from just one Pokémon battle with you..."}
tellraw @s[scores={DialogueTrigger=62,TalkTime=1}] {"text":"<Wally> About my own limits...and Ralts's..."}
tellraw @s[scores={DialogueTrigger=62,TalkTime=1}] ["",{"text":"<Wally> So...um... That's why... "},{"selector":"@s"},{"text":"... If it's all right... Could I..."}]
tellraw @s[scores={DialogueTrigger=62,TalkTime=1}] {"text":"<Wally> Could I call you...my r-riv—"}
tellraw @s[scores={DialogueTrigger=62,TalkTime=1}] {"text":"<Wally> Ah, never mind! S-sorry! It was nothing! Please forget about it!"}
tellraw @s[scores={DialogueTrigger=62,TalkTime=1}] {"text":"<Wally> Guh...good-bye!"}

#Wally tp out

tellraw @s[scores={DialogueTrigger=62,TalkTime=1}] {"text":"<Wally's Uncle> It just dawned on me that you must be the young trainer who kept an eye out for Wally when he caught his Pokémon."}
tellraw @s[scores={DialogueTrigger=62,TalkTime=1}] {"text":"<Wally's Uncle> So it's you we have to thank for Wally becoming so positive about the future."}
tellraw @s[scores={DialogueTrigger=62,TalkTime=1}] {"text":"<Wally's Uncle> Thank you."}
tellraw @s[scores={DialogueTrigger=62,TalkTime=1}] {"text":"<Wally's Uncle> ...Ah, here! Take this."}
...
tellraw @s[scores={DialogueTrigger=62,TalkTime=1}] {"text":"<Wally's Uncle> We should head back now, but..."}
tellraw @s[scores={DialogueTrigger=62,TalkTime=1}] {"text":"<Wally's Uncle> If you ever have the time, I'd love it if you'd stop by our home in Verdanturf."}
tellraw @s[scores={DialogueTrigger=62,TalkTime=1}] {"text":"<Wally's Uncle> I'm sure Wally would enjoy it, too."}
tellraw @s[scores={DialogueTrigger=62,TalkTime=1}] {"text":"<Wally's Uncle> We'll look forward to seeing you!"}
...
tellraw @s[scores={DialogueTrigger=75,TalkTime=1}] {"text":"<May> Ah!"}
tellraw @s[scores={DialogueTrigger=75,TalkTime=1}] ["",{"text":"<May> "},{"selector":"@s"},{"text":"!"}]
tellraw @s[scores={DialogueTrigger=75,TalkTime=1}] {"text":"<May> Look! Right up there! That's Mt. Chimney!"}

#Cutscene view

tellraw @s[scores={DialogueTrigger=75,TalkTime=1}] {"text":"<May> It sure is big..."}
tellraw @s[scores={DialogueTrigger=75,TalkTime=1}] {"text":"<May> No, more like huge..."}
tellraw @s[scores={DialogueTrigger=75,TalkTime=1}] {"text":"<May> It totally takes my breath away!"}
tellraw @s[scores={DialogueTrigger=75,TalkTime=1}] {"text":"<May> I'd love to take the Cable Car all the way up to the top someday..."}

#Back to normal view

tellraw @s[scores={DialogueTrigger=75,TalkTime=1}] ["",{"text":"<May> Hm? Hey, "},{"selector":"@s"},{"text":", don't your Pokémon seem a bit ragged around the edges?"}]
tellraw @s[scores={DialogueTrigger=75,TalkTime=1}] {"text":"<May> Here, let me give them a little boost!"}

execute as @s[scores={DialogueTrigger=75,TalkTime=1}] run pokeheal
tellraw @s[scores={DialogueTrigger=75,TalkTime=1}] {"text":"Your team's health was restored!","italic":true,"color":"gray"}
...
tellraw @s[scores={DialogueTrigger=75,TalkTime=1}] {"text":"<May> I bet you can find all kinds of ways to use it in the mountains that lie ahead!"}
tellraw @s[scores={DialogueTrigger=75,TalkTime=1}] {"text":"<May> But it won't work outside of battle if you don't have a Badge from Lavaridge Gym."}
tellraw @s[scores={DialogueTrigger=75,TalkTime=1}] {"text":"<May> Gasp! What am I doing nattering away here? I'm supposed to be on my way to Fallarbor to visit Professor Cozmo!"}
tellraw @s[scores={DialogueTrigger=75,TalkTime=1}] ["",{"text":"<May> I'm off for now, "},{"selector":"@s"},{"text":", but let's battle next time"}]
...
tellraw @s[scores={DialogueTrigger=75,TalkTime=1}] {"text":"<Brendan> Hm?"}
tellraw @s[scores={DialogueTrigger=75,TalkTime=1}] ["",{"text":"<Brendan> So it's you, "},{"selector":"@s"},{"text":"."}]
tellraw @s[scores={DialogueTrigger=75,TalkTime=1}] {"text":"<Brendan> You see that mountain up there? That's Mt. Chimney."}

#Cutscene view

tellraw @s[scores={DialogueTrigger=75,TalkTime=1}] {"text":"<Brendan> I dunno, but... But seeing it for real is, like..."}
tellraw @s[scores={DialogueTrigger=75,TalkTime=1}] {"text":"<Brendan> Like a punch in the gut, you know?"}
tellraw @s[scores={DialogueTrigger=75,TalkTime=1}] {"text":"<Brendan> Hope I might get to take the Cable Car up to the top someday..."}

#Back to normal view

tellraw @s[scores={DialogueTrigger=75,TalkTime=1}] ["",{"text":"<Brendan> Hey, "},{"selector":"@s"},{"text":", doesn't your team seem a bit worse for wear?"}]
tellraw @s[scores={DialogueTrigger=75,TalkTime=1}] {"text":"<Brendan> Here. I'll help them out for you."}

execute as @s[scores={DialogueTrigger=75,TalkTime=1}] run pokeheal
tellraw @s[scores={DialogueTrigger=75,TalkTime=1}] {"text":"Your team's health was restored!","italic":true,"color":"gray"}

tellraw @s[scores={DialogueTrigger=75,TalkTime=1}] {"text":"<Brendan> And why don't you take this?"}

tellraw @s[scores={DialogueTrigger=75,TalkTime=1}] ["",{"selector":"@s","italic":true,"color":"gray"},{"text":" obtained HM04 Strength","italic":true,"color":"gray"}]
#execute as @s[scores={DialogueTrigger=75,TalkTime=1}] run give @s

tellraw @s[scores={DialogueTrigger=75,TalkTime=1}] {"text":"<Brendan> I bet you can find all kinds of ways to use it in the mountains that lie ahead!"}
tellraw @s[scores={DialogueTrigger=75,TalkTime=1}] {"text":"<Brendan> Oh... But it won't work out here if you don't have a Badge from Lavaridge Gym."}
tellraw @s[scores={DialogueTrigger=75,TalkTime=1}] {"text":"<Brendan> Bah! This is no time to be giving you tricks!"}
...
tellraw @s[scores={DialogueTrigger=96,TalkTime=1}] {"text":"<Wally> Mr. Norman!"}
tellraw @s[scores={DialogueTrigger=96,TalkTime=1}] {"text":"<Wally> I haven't seen the two of you in some time."}
tellraw @s[scores={DialogueTrigger=96,TalkTime=1}] {"text":"<Wally> What a coincidence! I just came back to my parents' house to grab something I'd forgotten."}

tellraw @s[scores={DialogueTrigger=96,TalkTime=1}] {"text":"<Dad> You look like you've been working hard, Wally."}
tellraw @s[scores={DialogueTrigger=96,TalkTime=1}] {"text":"<Dad> It's clear even without a battle."}

tellraw @s[scores={DialogueTrigger=96,TalkTime=1}] {"text":"<Wally> R-really? You really think so?"}
tellraw @s[scores={DialogueTrigger=96,TalkTime=1}] {"text":"<Wally> Hehe... Thank you! That's so nice of you to say!"}

tellraw @s[scores={DialogueTrigger=96,TalkTime=1}] {"text":"<Wally's Dad> As you can see, Wally's health has thoroughly improved."}
tellraw @s[scores={DialogueTrigger=96,TalkTime=1}] {"text":"<Wally's Dad> It's all thanks to you and your father."}
tellraw @s[scores={DialogueTrigger=96,TalkTime=1}] {"text":"<Wally's Dad> You two helped Wally catch his first Pokémon that day."}
tellraw @s[scores={DialogueTrigger=96,TalkTime=1}] {"text":"<Wally's Dad> It's because of you that he has a partner of his own now."}
tellraw @s[scores={DialogueTrigger=96,TalkTime=1}] {"text":"<Wally's Dad> That partner is why he's grown so strong. That's my firm belief. So, I thank you."}
#Summons exclamation
...
tellraw @s[scores={DialogueTrigger=96,TalkTime=1}] {"text":"<Wally's Dad> If you're cleared to use Surf outside of battle, you'll be able to cross seas with your Pokémon."}

tellraw @s[scores={DialogueTrigger=96,TalkTime=1}] ["",{"text":"<Dad> "},{"selector":"@s"},{"text":"..."}]
tellraw @s[scores={DialogueTrigger=96,TalkTime=1}] {"text":"<Dad> Considering how much you and Wally have grown, you should be able to handle what lies beyond the sea on Route 118 now."}
tellraw @s[scores={DialogueTrigger=96,TalkTime=1}] {"text":"<Dad> There are far stronger Pokémon and Trainers waiting for you on Hoenn's east coast."}
tellraw @s[scores={DialogueTrigger=96,TalkTime=1}] {"text":"<Dad> Continue your journey and your adventures there. I know you'll do your best!"}

tellraw @s[scores={DialogueTrigger=96,TalkTime=1}] {"text":"<Wally> Yes, sir!"}
tellraw @s[scores={DialogueTrigger=96,TalkTime=1}] ["",{"text":"<Wally> I will do my best to become as strong as "},{"selector":"@s"},{"text":", sir!"}]
tellraw @s[scores={DialogueTrigger=96,TalkTime=1}] {"text":"<Wally> I guess I had better start out, then."}
tellraw @s[scores={DialogueTrigger=96,TalkTime=1}] {"text":"<Wally> I'm off for now, Dad! See you next time!"}
tellraw @s[scores={DialogueTrigger=96,TalkTime=1}] ["",{"text":"<Wally> Um. Come on, "},{"selector":"@s"},{"text":"! Let's go together!"}]

tellraw @s[scores={DialogueTrigger=96,TalkTime=1}] {"text":"<Dad> Wally..."}
tellraw @s[scores={DialogueTrigger=96,TalkTime=1}] {"text":"<Dad> I look forward to seeing you and your Pokémon grow stronger together."}
tellraw @s[scores={DialogueTrigger=96,TalkTime=1}] ["",{"text":"<Dad> "},{"selector":"@s"},{"text":"? Well, take care of yourself out there."}]
tellraw @s[scores={DialogueTrigger=96,TalkTime=1}] {"text":"<Dad> Don't forget to drop by Littleroot to visit your mother from time to time!"}

tellraw @s[scores={DialogueTrigger=96,TalkTime=1}] {"text":"<Wally> OK! We're off!"}

tellraw @s[scores={DialogueTrigger=96,TalkTime=1}] {"text":"<Wally's Dad> Be safe out there!"}

tellraw @s[scores={DialogueTrigger=96,TalkTime=1}] {"text":"<Dad> Learn a lot!"}
...
tellraw @s[scores={DialogueTrigger=97,TalkTime=1}] {"text":"<Steven> We met in Granite Cave, didn't we?"}
tellraw @s[scores={DialogueTrigger=97,TalkTime=1}] ["",{"text":"<Steven> No, I remember it. It's "},{"selector":"@s"},{"text":"... Right?"}]
tellraw @s[scores={DialogueTrigger=97,TalkTime=1}] {"text":"<Steven> It's good to see that your journey is going well."}
tellraw @s[scores={DialogueTrigger=97,TalkTime=1}] ["",{"text":"<Steven> You know, "},{"selector":"@s"},{"text":"..."}]
tellraw @s[scores={DialogueTrigger=97,TalkTime=1}] {"text":"<Steven> In this vast world, there are many kinds of Pokémon."}
tellraw @s[scores={DialogueTrigger=97,TalkTime=1}] {"text":"<Steven> They come in many types."}
tellraw @s[scores={DialogueTrigger=97,TalkTime=1}] {"text":"<Steven> Should you raise different types?"}
tellraw @s[scores={DialogueTrigger=97,TalkTime=1}] {"text":"<Steven> Or will you only raise Pokémon of a certain type you like?"}
tellraw @s[scores={DialogueTrigger=97,TalkTime=1}] {"text":"<Steven> I wonder what you think, as a Pokémon Trainer?"}
tellraw @s[scores={DialogueTrigger=97,TalkTime=1}] {"text":"<Steven> Not that it's anything I should be concerning myself with..."}
tellraw @s[scores={DialogueTrigger=97,TalkTime=1}] {"text":"<Steven> But somehow I find myself wanting to know what you think."}
tellraw @s[scores={DialogueTrigger=97,TalkTime=1}] {"text":"<Steven> I suppose I should be going. I hope to see you again though."}

tellraw @s[scores={DialogueTrigger=97,TalkTime=1}] {"text":"<Steven> ...Hm?"}

#Summons legendary statue over water

tellraw @s[scores={DialogueTrigger=97,TalkTime=1}] {"text":"Hyahhn","bold":true,"italic":true}
tellraw @s[scores={DialogueTrigger=97,TalkTime=1}] {"text":"<Steven> Latias!"}
tellraw @s[scores={DialogueTrigger=97,TalkTime=1}] {"text":"<Latias> Hyaahh!"}

tellraw @s[scores={DialogueTrigger=97,TalkTime=1}] {"text":"Shwahhn","bold":true,"italic":true}
tellraw @s[scores={DialogueTrigger=97,TalkTime=1}] {"text":"<Steven> Latios!"}
tellraw @s[scores={DialogueTrigger=97,TalkTime=1}] {"text":"<Latios> Shwaahh!"}

tellraw @s[scores={DialogueTrigger=97,TalkTime=1}] {"text":"<Steven> Do you...want us to soar somewhere with you?"}
tellraw @s[scores={DialogueTrigger=97,TalkTime=1}] ["",{"text":"<Steven> "},{"selector":"@s"},{"text":"."}]
tellraw @s[scores={DialogueTrigger=97,TalkTime=1}] {"text":"<Steven> Come with me."}

tellraw @s[scores={DialogueTrigger=97,TalkTime=1}] {"text":"<Steven> Latias... I believe that it sought us out for help."}
tellraw @s[scores={DialogueTrigger=97,TalkTime=1}] {"text":"<Steven> Latios... I believe that it sought us out for help."}
tellraw @s[scores={DialogueTrigger=97,TalkTime=1}] {"text":"<Steven> If that's the case, let's go!"}
...
tellraw @s[scores={DialogueTrigger=97,TalkTime=1}] {"text":"<Steven> We've arrived."}
tellraw @s[scores={DialogueTrigger=97,TalkTime=1}] {"text":"<Steven> Thank you, Latias."}
tellraw @s[scores={DialogueTrigger=97,TalkTime=1}] {"text":"<Steven> Thank you, Latios."}
tellraw @s[scores={DialogueTrigger=97,TalkTime=1}] {"text":"<Steven> ..."}
tellraw @s[scores={DialogueTrigger=97,TalkTime=1}] {"text":"<Steven> I don't know what it is..."}
tellraw @s[scores={DialogueTrigger=97,TalkTime=1}] {"text":"<Steven> Not quite unease, not quite fear..."}
tellraw @s[scores={DialogueTrigger=97,TalkTime=1}] {"text":"<Steven> But there is something...unsettling..."}
tellraw @s[scores={DialogueTrigger=97,TalkTime=1}] {"text":"<Steven> It is an odd feeling, as though I am walking in a dream— or an illusion."}
tellraw @s[scores={DialogueTrigger=97,TalkTime=1}] {"text":"<Steven> I once heard an odd fable."}
tellraw @s[scores={DialogueTrigger=97,TalkTime=1}] {"text":"<Steven> It was said that the two Pokémon that live on this island guard some secret about that great form of Evolution: Mega Evolution."}
tellraw @s[scores={DialogueTrigger=97,TalkTime=1}] {"text":"<Steven> Could it be that some dangerous element is here because of that?"}
tellraw @s[scores={DialogueTrigger=97,TalkTime=1}] {"text":"<Steven> ..."}
...
#teleports Steven in
tellraw @s[scores={DialogueTrigger=99,TalkTime=1}] {"text":"<Steven> Latios..."}
tellraw @s[scores={DialogueTrigger=99,TalkTime=1}] {"text":"<Steven> It's beautiful..."}
tellraw @s[scores={DialogueTrigger=99,TalkTime=1}] {"text":"<Steven> If I were to describe such beauty in terms of a stone, it would be a Water Stone."}
tellraw @s[scores={DialogueTrigger=99,TalkTime=1}] {"text":"<Steven> No... It goes beyond that..."}
tellraw @s[scores={DialogueTrigger=99,TalkTime=1}] {"text":"<Steven> Isn't its brilliance like that of a Dawn Stone?"}
tellraw @s[scores={DialogueTrigger=99,TalkTime=1}] {"text":"<Steven> It is as fantastic as a Steel-type Pokémon..."}



tellraw @s[scores={DialogueTrigger=99,TalkTime=1}] {"text":"<Steven> Latias..."}
tellraw @s[scores={DialogueTrigger=99,TalkTime=1}] {"text":"<Steven> It's beautiful..."}
tellraw @s[scores={DialogueTrigger=99,TalkTime=1}] {"text":"<Steven> If I were to describe such beauty in terms of a stone, it would be a Sun Stone."}
tellraw @s[scores={DialogueTrigger=99,TalkTime=1}] {"text":"<Steven> No... It goes beyond that..."}
tellraw @s[scores={DialogueTrigger=99,TalkTime=1}] {"text":"<Steven> Isn't its brilliance like that of a Dawn Stone?"}
tellraw @s[scores={DialogueTrigger=99,TalkTime=1}] {"text":"<Steven> It is as fantastic as a Steel-type Pokémon..."}
...
tellraw @s[scores={DialogueTrigger=100,TalkTime=1}] {"text":"<Team Magma Courtney> As anticipated."}
tellraw @s[scores={DialogueTrigger=100,TalkTime=1}] {"text":"<Team Magma Courtney> Unanticipated."}
tellraw @s[scores={DialogueTrigger=100,TalkTime=1}] {"text":"<Team Magma Courtney> You. Target lock...completed."}
tellraw @s[scores={DialogueTrigger=100,TalkTime=1}] {"text":"<Team Magma Courtney> Commencing...experiment. You. Forever. Aha... ♪"}
tellraw @s[scores={DialogueTrigger=100,TalkTime=1}] {"text":"<Team Magma Courtney> Returning home."}

#tps Courtney out

tellraw @s[scores={DialogueTrigger=100,TalkTime=1}] {"text":"<Team Magma Grunt> W-wait for me! Courtne-e-e-y!"}

#tp Grunt out

tellraw @s[scores={DialogueTrigger=100,TalkTime=1}] {"text":"<Steven> Hah..."}
tellraw @s[scores={DialogueTrigger=100,TalkTime=1}] ["",{"text":"<Steven> Good work, "},{"selector":"@s"},{"text":"."}]
tellraw @s[scores={DialogueTrigger=100,TalkTime=1}] {"text":"<Steven> Ah, that's right."}
tellraw @s[scores={DialogueTrigger=100,TalkTime=1}] {"text":"<Steven> We should first heal up the Pokémon that fought on our behalf, shouldn't we?"}

tellraw @s[scores={DialogueTrigger=100,TalkTime=1}] {"text":"Your team's health was restored!","italic":true,"color":"gray"}

tellraw @s[scores={DialogueTrigger=100,TalkTime=1}] {"text":"<Steven> You performed spectacularly."}
tellraw @s[scores={DialogueTrigger=100,TalkTime=1}] {"text":"<Steven> We were able to protect both this wondrous Pokémon and its Mega Stone, thanks to you."}

#Lati Cry

tellraw @s[scores={DialogueTrigger=100,TalkTime=1}] {"text":"<Steven> And it looks as though Latios may have also recognized you as a Trainer worthy of its trust."}
tellraw @s[scores={DialogueTrigger=100,TalkTime=1}] {"text":"<Steven> And it looks as though Latias may have also recognized you as a Trainer worthy of its trust."}
tellraw @s[scores={DialogueTrigger=100,TalkTime=1}] {"text":"<Steven> Look. It's trying to offer you its allegiance."}
tellraw @s[scores={DialogueTrigger=100,TalkTime=1}] {"text":"<Steven> I believe it is trying to show that it wants to go with you on your journey."}
tellraw @s[scores={DialogueTrigger=100,TalkTime=1}] {"text":"<Steven> Go on. Hold out your hand to it."}

tellraw @s[scores={DialogueTrigger=100,TalkTime=1}] {"text":"Latios joined your team!"}
tellraw @s[scores={DialogueTrigger=100,TalkTime=1}] {"text":"Latias joined your team!"}

#Vanish Lati statue

tellraw @s[scores={DialogueTrigger=100,TalkTime=1}] {"text":"Latios is carrying a piece of Latiosite!"}
tellraw @s[scores={DialogueTrigger=100,TalkTime=1}] {"text":"Latias is carrying a piece of Latiasite!"}

tellraw @s[scores={DialogueTrigger=100,TalkTime=1}] {"text":"<Steven> You should take this from me..."}

tellraw @s[scores={DialogueTrigger=100,TalkTime=1}] ["",{"selector":"@s","italic":true,"color":"gray"},{"text":" obtained the Mega Braclet!","italic":true,"color":"gray"}]

tellraw @s[scores={DialogueTrigger=100,TalkTime=1}] {"text":"<Steven> With the Mega Bracelet that I just gave you and the Mega Stones that a Pokémon may hold,"}
tellraw @s[scores={DialogueTrigger=100,TalkTime=1}] {"text":"<Steven> your Pokémon will be able to achieve a powerful boost, quite unlike any usual form of Evolution..."}
tellraw @s[scores={DialogueTrigger=100,TalkTime=1}] {"text":"<Steven> but only if you are bound by great affection."}
tellraw @s[scores={DialogueTrigger=100,TalkTime=1}] {"text":"<Steven> You will be able to achieve Mega Evolution."}

tellraw @s[scores={DialogueTrigger=100,TalkTime=1}] {"text":"<Steven> I suggest you try it with Latios the next time that you happen to have the chance in battle."}
tellraw @s[scores={DialogueTrigger=100,TalkTime=1}] {"text":"<Steven> I suggest you try it with Latias the next time that you happen to have the chance in battle."}

tellraw @s[scores={DialogueTrigger=100,TalkTime=1}] {"text":"<Steven> Mega Evolution is a phenomenon that has long been shrouded in mystery."}
tellraw @s[scores={DialogueTrigger=100,TalkTime=1}] {"text":"<Steven> What is a Mega Stone? What is a Key Stone?"}
tellraw @s[scores={DialogueTrigger=100,TalkTime=1}] {"text":"<Steven> The process by which bonds between Pokémon and people manifest in tangible power..."}
tellraw @s[scores={DialogueTrigger=100,TalkTime=1}] {"text":"<Steven> How do we explain that?"}
tellraw @s[scores={DialogueTrigger=100,TalkTime=1}] {"text":"<Steven> I hope that the Mega Bracelet I just gave you might bring us one step closer to finding the answer to these questions."}
tellraw @s[scores={DialogueTrigger=100,TalkTime=1}] {"text":"<Steven> If that settles that... Should we be heading back?"}

tellraw @s[scores={DialogueTrigger=100,TalkTime=1}] {"text":"<Steven> Together with Latias, waiting so patiently for us there..."}
tellraw @s[scores={DialogueTrigger=100,TalkTime=1}] {"text":"<Steven> Together with Latios, waiting so patiently for us there..."}
...
tellraw @s[scores={DialogueTrigger=100,TalkTime=1}] ["",{"text":"<Steven> Thank you for your help, "},{"selector":"@s"},{"text":"."}]

tellraw @s[scores={DialogueTrigger=100,TalkTime=1}] {"text":"<Latias> Hyan!"}
tellraw @s[scores={DialogueTrigger=100,TalkTime=1}] {"text":"<Latios> Shwan!"}

tellraw @s[scores={DialogueTrigger=100,TalkTime=1}] {"text":"<Steven> Perhaps it's trying to tell you to take good care of Latios."}
tellraw @s[scores={DialogueTrigger=100,TalkTime=1}] {"text":"<Steven> Perhaps it's trying to tell you to take good care of Latias."}

tellraw @s[scores={DialogueTrigger=100,TalkTime=1}] {"text":"<Latias> Hyaahhn!"}
tellraw @s[scores={DialogueTrigger=100,TalkTime=1}] {"text":"<Latios> Shwaahhn!"}

#flies away

tellraw @s[scores={DialogueTrigger=100,TalkTime=1}] {"text":"<Steven> In the end, you were a far greater help than I expected you might be."}
tellraw @s[scores={DialogueTrigger=100,TalkTime=1}] {"text":"<Steven> I expect that you and your team will be able to best both Route 119 ahead and even the Fortree Gym beyond that."}
tellraw @s[scores={DialogueTrigger=100,TalkTime=1}] {"text":"<Steven> I'll be curious to see how much stronger you might grow by the next time we meet."}
tellraw @s[scores={DialogueTrigger=100,TalkTime=1}] ["",{"text":"<Steven> Until then, "},{"selector":"@s"},{"text":"."}]
...
tellraw @s[scores={DialogueTrigger=105,TalkTime=1}] ["",{"text":"<May> "},{"selector":"@s"},{"text":"!"}]
tellraw @s[scores={DialogueTrigger=105,TalkTime=1}] {"text":"<May> Gosh, where have you been hiding? I've been looking all over for you!"}
#summon question mark
tellraw @s[scores={DialogueTrigger=105,TalkTime=1}] {"text":"<May> Oh... Where did you get that thing on your wrist?"}
tellraw @s[scores={DialogueTrigger=105,TalkTime=1}] {"text":"<May> That's a pretty fancy-looking bracelet..."}
tellraw @s[scores={DialogueTrigger=105,TalkTime=1}] {"text":"<May> ..."}
tellraw @s[scores={DialogueTrigger=105,TalkTime=1}] {"text":"<May> Wow! So that's a Mega Bracelet? And you can use it for Mega Evolution..."}
tellraw @s[scores={DialogueTrigger=105,TalkTime=1}] {"text":"<May> I guess now you can keep getting even closer to your Pokémon, huh?"}
tellraw @s[scores={DialogueTrigger=105,TalkTime=1}] {"text":"<May> Some people have all the luck..."}
tellraw @s[scores={DialogueTrigger=105,TalkTime=1}] {"text":"<May> But I'm not about to lose to you and some accessory!"}
tellraw @s[scores={DialogueTrigger=105,TalkTime=1}] {"text":"<May> Let's see who's best in battle!"}
tellraw @s[scores={DialogueTrigger=105,TalkTime=1}] {"text":"<May> Are your Pokémon all ready? Of course they are! Let's go!"}

#pokebattle

tellraw @s[scores={DialogueTrigger=105,TalkTime=1}] ["",{"text":"<Brendan> "},{"selector":"@s"},{"text":"!"}]
tellraw @s[scores={DialogueTrigger=105,TalkTime=1}] {"text":"<Brendan> You've been looking for Pokémon here?"}
tellraw @s[scores={DialogueTrigger=105,TalkTime=1}] {"text":"<Brendan> Huh? That bracelet you've got on..."}
tellraw @s[scores={DialogueTrigger=105,TalkTime=1}] {"text":"<Brendan> It's like, I don't know, really cool..."}
tellraw @s[scores={DialogueTrigger=105,TalkTime=1}] {"text":"<Brendan> ..."}
tellraw @s[scores={DialogueTrigger=105,TalkTime=1}] {"text":"<Brendan> Whoa. So that's the Mega Bracelet? And you can use it for Mega Evolution..."}
tellraw @s[scores={DialogueTrigger=105,TalkTime=1}] {"text":"<Brendan> So you'll just keep getting closer to your Pokémon and getting even stronger..."}
tellraw @s[scores={DialogueTrigger=105,TalkTime=1}] {"text":"<Brendan> All right, then. I guess I've just gotta help you test how strong you've become, huh?"}
...
tellraw @s[scores={DialogueTrigger=106,TalkTime=1}] {"text":"<May> If you use Fly, your Pokémon will carry you back to anywhere you've been before."}
tellraw @s[scores={DialogueTrigger=106,TalkTime=1}] {"text":"<May> But you must have the Gym Badge from Fortree City to use Fly outside of battle."}
tellraw @s[scores={DialogueTrigger=106,TalkTime=1}] {"text":"<May> That's the most important bit, so don't forget!"}
tellraw @s[scores={DialogueTrigger=106,TalkTime=1}] {"text":"<May> Maybe you should Fly home and visit Littleroot sometimes."}
tellraw @s[scores={DialogueTrigger=106,TalkTime=1}] ["",{"text":"<May> I bet your mom worries about you, "},{"selector":"@s"},{"text":"..."}]
tellraw @s[scores={DialogueTrigger=106,TalkTime=1}] {"text":"<May> Well, till we meet again!"}
tellraw @s[scores={DialogueTrigger=106,TalkTime=1}] {"text":"<May> And next time I won't lose!"}
...
tellraw @s[scores={DialogueTrigger=106,TalkTime=1}] {"text":"<Brendan> With Fly, your Pokémon can carry you back to just about anyplace you've visited before."}
tellraw @s[scores={DialogueTrigger=106,TalkTime=1}] {"text":"<Brendan> Of course, you'll need the Fortree Gym Badge first, though..."}
...
tellraw @s[scores={DialogueTrigger=147,TalkTime=1}] {"text":"<Groudon> Gurrrooouuuhhh!!!"}

#Groudon transforms into Primal form
#Could form glass crystals around it during transformation?

#Text if legend is defeated
tellraw @s[scores={DialogueTrigger=147,TalkTime=1}] {"text":"Groudon disappeared deep beneath the magma...","italic":true,"color":"gray"}
...
tellraw @s[scores={DialogueTrigger=148,TalkTime=1}] {"text":"<Kyogre> Krrraaawwwrrr!!!"}
