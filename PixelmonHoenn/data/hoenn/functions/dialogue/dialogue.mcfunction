...
tellraw @s[scores={DialogueTrigger=1,TalkTime=1}] {"text":"<...> Hi! Sorry to keep you waiting!!"}
tellraw @s[scores={DialogueTrigger=1,TalkTime=1}] {"text":"<...> Welcome to the world of Pokémon!!"}
tellraw @s[scores={DialogueTrigger=1,TalkTime=1}] {"text":"<...> My name is Birch.!"}

#Player sets down their PokeNav

tellraw @s[scores={DialogueTrigger=1,TalkTime=1}] {"text":"<Professor Birch> But everyone calls me the Pokémon Professor."}
tellraw @s[scores={DialogueTrigger=1,TalkTime=1}] {"text":"<Professor Birch> And this...is what we call a \"Pokémon.\""}
tellraw @s[scores={DialogueTrigger=1,TalkTime=1}] {"text":"<Professor Birch> This world is widely inhabited by creatures known as Pokémon."}
tellraw @s[scores={DialogueTrigger=1,TalkTime=1}] {"text":"<Professor Birch> We humans live alongside Pokémon, at times playing together as friends, and at times helping one another out."}
tellraw @s[scores={DialogueTrigger=1,TalkTime=1}] {"text":"<Professor Birch> And sometimes, we just like to have fun battling others like us!"}
tellraw @s[scores={DialogueTrigger=1,TalkTime=1}] {"text":"<Professor Birch> But as close as we are, we don't know everything about Pokémon."}
tellraw @s[scores={DialogueTrigger=1,TalkTime=1}] {"text":"<Professor Birch> In fact, there are still many, many mysteries surrounding Pokémon."}
tellraw @s[scores={DialogueTrigger=1,TalkTime=1}] {"text":"<Professor Birch> I do research to try to unravel those Pokémon mysteries. But that's enough about me!"}
tellraw @s[scores={DialogueTrigger=1,TalkTime=1}] {"text":"<Professor Birch> What about you?"}
tellraw @s[scores={DialogueTrigger=1,TalkTime=1}] {"text":"<Professor Birch> Will you give me your name?"}
tellraw @s[scores={DialogueTrigger=1,TalkTime=1}] ["",{"text":"<Professor Birch> So you're @"},{"selector":"s"},{"text":"?"}]
tellraw @s[scores={DialogueTrigger=1,TalkTime=1}] {"text":"<Professor Birch> Ah... I see!"}
tellraw @s[scores={DialogueTrigger=1,TalkTime=1}] ["",{"text":"<Professor Birch> You're THAT "},{"selector":"@s"},{"text":"! You're the one who's moving to Littleroot Town, where I live!"}]
tellraw @s[scores={DialogueTrigger=1,TalkTime=1}] {"text":"<Professor Birch> Are you ready?"}
tellraw @s[scores={DialogueTrigger=1,TalkTime=1}] {"text":"<Professor Birch> Your very own adventure is now about to unfold!"}
...
execute at @s[scores={DialogueTrigger=42,TalkTime=1}] as @e[type=pixelmon:npc_chatting,distance=..10] at @s run tp @s ~ ~ ~ facing entity @p[distance=..15]
tellraw @s[scores={DialogueTrigger=42,TalkTime=5}] {"text":"<...> Yes?"}
tellraw @s[scores={DialogueTrigger=42,TalkTime=12}] {"text":"<Captain Stern> If you're looking for Stern, that would be me."}
tellraw @s[scores={DialogueTrigger=42,TalkTime=20}] {"text":"<Captain Stern> Ah! Those must be the parts I ordered from Mr. Stone at Devon."}
tellraw @s[scores={DialogueTrigger=42,TalkTime=28}] {"text":"<Captain Stern> Thank you for bringing the case all this way."}
tellraw @s[scores={DialogueTrigger=42,TalkTime=35}] {"text":"<Captain Stern> Now we can prepare for our expedition at last!"}

execute as @s[scores={DialogueTrigger=42,TalkTime=40},tag=!MusicDisabled] run stopsound @s record
execute as @s[scores={DialogueTrigger=42,TalkTime=40},tag=!MusicDisabled] run playsound minecraft:teamappears record @s ~ ~ ~ 1 1 1
execute as @s[scores={DialogueTrigger=42,TalkTime=40},tag=!MusicDisabled] run scoreboard players set @s MusicCooldown 69

#Team Grunts teleport in
execute as @s[scores={DialogueTrigger=42,TalkTime=40,GameVersion=1}] run particle cloud -1382 15 270 1 1 1 0.15 300
execute as @s[scores={DialogueTrigger=42,TalkTime=40,GameVersion=1}] run particle cloud -1384 15 270 1 1 1 0.15 300
execute as @s[scores={DialogueTrigger=42,TalkTime=40,GameVersion=1}] run summon pixelmon:npc_chatting -1382 15 270 {HurtByTimestamp: 0, chatNum: 0, Invulnerable: 0b, FallFlying: 0b, PortalCooldown: 0, AbsorptionAmount: 0.0f, Name: "Magma Grunt", FallDistance: 0.0f, CanUpdate: 1b, DeathTime: 0s, DefaultName: 0b, Commands: {interactCommands: []}, HandDropChances: [0.085f, 0.085f], PersistenceRequired: 1b, trainerLocation: 2, DefaultGreet: 0b, TextureIndex: 4, TrainerIndex: "madame", NameIndex: 4, Health: 20.0f, LeftHanded: 0b, Air: 300s, OnGround: 1b, Rotation: [0.0f, 0.0f], HandItems: [{}, {}], ChatIndex: 0, Profession: -1s,Fire: -1s, ArmorItems: [{}, {}, {}, {}], CanPickUpLoot: 0b, CustomSteveTexture: "magmagruntmale.png", HurtTime: 0s, BaseTrainer: "Steve", Inventory: [], AIMode: 2s}
execute as @s[scores={DialogueTrigger=42,TalkTime=40,GameVersion=1}] unless entity @e[x=-1384,y=15,z=270,dy=3,type=pixelmon:npc_trainer] run summon pixelmon:npc_trainer -1384 15 270 {Brain: {memories: {}}, HurtByTimestamp: 0, NPCLevel: 32, RaiseToCap: 0b, TeamSelectTime: 0, LevelCap: 100, Attributes: [{Base: 0.0d, Name: "forge:step_height_addition"}, {Base: 0.699999988079071d, Name: "minecraft:generic.movement_speed"}, {Base: 0.08d, Name: "forge:entity_gravity"}, {Base: 10.0d, Modifiers: [{Amount: 0.07305606215663946d, Operation: 1, Name: "Random spawn bonus"}], Name: "minecraft:generic.follow_range"}], BattleType: 0, Invulnerable: 0b, AbsorptionAmount: 0.0f, DefaultLose: 1b, Name: "Magma Grunt", FallDistance: 0.0f, WinningsTag: {item0: {id: "minecraft:nether_brick", Count: 1b}}, CanUpdate: 1b, BossTier: "notboss", DefaultName: 1b, hasMegaItem: 0, TeamPreview: 0b, HandDropChances: [0.085f, 0.085f], PersistenceRequired: 1b, FullHeal: 0b, trainerLocation: 2, oldGen: 0, OldGen: 0, pokeStore: {party1: {EVSpeed: 0s, StatsDefense: 14s, IVAttack: 11b, Growth: 3b, PHiddenAbility: 0b, Moveset: [{MoveID: "Tackle", MovePP: 35b}, {MoveID: "Ember", MovePP: 40b}], PersistentData: {}, Gender: 1b, GigantamaxFactor: 0b, Friendship: 0s, eggCycles: -1, EVAttack: 0s, StatsSpecialAttack: 10s, IVSpDef: 11b, CaughtBall: "poke_ball", IVHP: 18b, EVHP: 0s, ndex: 322, palette: "none", StatsSpecialDefense: 11s, Nature: 10b, Ability: "QuickFeet", StatsHP: 26s, IVDefense: 21b, Health: 26, SpecFlags: [], DoesLevel: 1b, EVDefense: 0s, PAbilitySlot: 1, DynamaxLevel: 0, Variant: "", StatsSpeed: 9s, EVSpecialAttack: 0s, StatsAttack: 15s, IVSpeed: 3b, Level: 9, IVSpAtt: 2b, NBT_VERSION: 2b, EVSpecialDefense: 0s, EXP: 0, RelrnMoves: [], ribbons2: []}, TempPartyEnabled: 0b}, EncMode: 1s, Air: 300s, HandItems: [{}, {}], ArmorDropChances: [0.085f, 0.085f, 0.085f, 0.085f], Profession: 0s, Pos: [-2719.491015649672d, 69.0d, -227.49195215342667d], CanPickUpLoot: 1b, HurtTime: 0s, Inventory: [], DefaultWin: 1b, WinMessage: "", Greeting: "", Exitable: 1b, TrainerRotation: 0.0f, Encounters: [], FallFlying: 0b, PortalCooldown: 0, TurnTime: 0, DeathTime: 0s, Commands: {winCommands: [], loseCommands: [], preBattleCommands: [], interactCommands: [], forfeitCommands: []}, GymLeader: 0b, EngageDistance: 10, DefaultGreet: 1b, Motion: [0.0d, -0.0784000015258789d, 0.0d], TrainerIndex: "malemagmagrunt", Health: 20.0f, BattleAIMode: 0s, LoseMessage: "", LeftHanded: 0b, OnGround: 1b, Rotation: [0.0f, 0.0f], ChatIndex: 13, Fire: -1s, ArmorItems: [{}, {}, {}, {}], CustomSteveTexture: "magmagruntmale.png", NumPokemon: 6, "forge:spawn_type": "COMMAND", BaseTrainer: "MaleMagmaGrunt", WinMoney: 360, AIMode: 1s}


execute as @s[scores={DialogueTrigger=42,TalkTime=40,GameVersion=2}] run particle cloud -1382 -12 270 1 1 1 0.15 300
execute as @s[scores={DialogueTrigger=42,TalkTime=40,GameVersion=2}] run particle cloud -1384 -12 270 1 1 1 0.15 300
execute as @s[scores={DialogueTrigger=42,TalkTime=40,GameVersion=2}] run summon pixelmon:npc_chatting -1382 -12 270 {HurtByTimestamp: 0, chatNum: 0, Invulnerable: 0b, FallFlying: 0b, PortalCooldown: 0, AbsorptionAmount: 0.0f, Name: "Aqua Grunt", FallDistance: 0.0f, CanUpdate: 1b, DeathTime: 0s, DefaultName: 0b, Commands: {interactCommands: []}, HandDropChances: [0.085f, 0.085f], PersistenceRequired: 1b, trainerLocation: 2, DefaultGreet: 0b, TextureIndex: 4, TrainerIndex: "madame", NameIndex: 4, Health: 20.0f, LeftHanded: 0b, Air: 300s, OnGround: 1b, Rotation: [180.0f, 0.0f], HandItems: [{}, {}], ChatIndex: 0, Profession: -1s,Fire: -1s, ArmorItems: [{}, {}, {}, {}], CanPickUpLoot: 0b, CustomSteveTexture: "aquagruntmale.png", HurtTime: 0s, BaseTrainer: "Steve", Inventory: [], AIMode: 2s}
execute as @s[scores={DialogueTrigger=42,TalkTime=40,GameVersion=2}] unless entity @e[x=-1384,y=-12,z=270,dy=3,type=pixelmon:npc_trainer] run summon pixelmon:npc_trainer -1384 -12 270 {Brain: {memories: {}}, HurtByTimestamp: 0, NPCLevel: 15, RaiseToCap: 0b, TeamSelectTime: 0, LevelCap: 100, Attributes: [{Base: 0.0d, Name: "forge:step_height_addition"}, {Base: 0.699999988079071d, Name: "minecraft:generic.movement_speed"}, {Base: 0.08d, Name: "forge:entity_gravity"}, {Base: 10.0d, Modifiers: [{Amount: 0.07305606215663946d, Operation: 1, Name: "Random spawn bonus"}], Name: "minecraft:generic.follow_range"}], BattleType: 0, Invulnerable: 0b, AbsorptionAmount: 0.0f, DefaultLose: 1b, Name: "Magma Grunt", FallDistance: 0.0f, WinningsTag: {item0: {id: "minecraft:nether_brick", Count: 1b}}, CanUpdate: 1b, BossTier: "notboss", DefaultName: 1b, hasMegaItem: 0, TeamPreview: 0b, HandDropChances: [0.085f, 0.085f], PersistenceRequired: 1b, FullHeal: 0b, trainerLocation: 2, oldGen: 0, OldGen: 0, pokeStore: {party1: {EVSpeed: 0s, StatsDefense: 14s, IVAttack: 11b, Growth: 3b, PHiddenAbility: 0b, Moveset: [{MoveID: "Aqua Jet", MovePP: 35b}, {MoveID: "Bite", MovePP: 40b}], PersistentData: {}, Gender: 1b, GigantamaxFactor: 0b, Friendship: 0s, eggCycles: -1, EVAttack: 0s, StatsSpecialAttack: 10s, IVSpDef: 11b, CaughtBall: "poke_ball", IVHP: 18b, EVHP: 0s, ndex: 318, palette: "none", StatsSpecialDefense: 11s, Nature: 10b, Ability: "QuickFeet", StatsHP: 26s, IVDefense: 21b, Health: 26, SpecFlags: [], DoesLevel: 1b, EVDefense: 0s, PAbilitySlot: 1, DynamaxLevel: 0, Variant: "", StatsSpeed: 9s, EVSpecialAttack: 0s, StatsAttack: 15s, IVSpeed: 3b, Level: 9, IVSpAtt: 2b, NBT_VERSION: 2b, EVSpecialDefense: 0s, EXP: 0, RelrnMoves: [], ribbons2: []}, TempPartyEnabled: 0b}, EncMode: 1s, Air: 300s, HandItems: [{}, {}], ArmorDropChances: [0.085f, 0.085f, 0.085f, 0.085f], Profession: 0s, Pos: [-2719.491015649672d, 69.0d, -227.49195215342667d], CanPickUpLoot: 1b, HurtTime: 0s, Inventory: [], DefaultWin: 1b, WinMessage: "", Greeting: "", Exitable: 1b, TrainerRotation: 0.0f, Encounters: [], FallFlying: 0b, PortalCooldown: 0, TurnTime: 0, DeathTime: 0s, Commands: {winCommands: [], loseCommands: [], preBattleCommands: [], interactCommands: [], forfeitCommands: []}, GymLeader: 0b, EngageDistance: 10, DefaultGreet: 1b, Motion: [0.0d, -0.0784000015258789d, 0.0d], TrainerIndex: "malemagmagrunt", Health: 20.0f, BattleAIMode: 0s, LoseMessage: "", LeftHanded: 0b, OnGround: 1b, Rotation: [0.0f, 0.0f], ChatIndex: 13, Fire: -1s, ArmorItems: [{}, {}, {}, {}], CustomSteveTexture: "aquagruntmale.png", NumPokemon: 6, "forge:spawn_type": "COMMAND", BaseTrainer: "MaleAquaGrunt", WinMoney: 360, AIMode: 1s}

tellraw @s[scores={DialogueTrigger=42,TalkTime=44,GameVersion=1}] {"text":"<Team Magma Grunt> Hah hah hah hah... Just a moment! We'll be taking those parts!"}
tellraw @s[scores={DialogueTrigger=42,TalkTime=44,GameVersion=2}] {"text":"<Team Aqua Grunt> Heh heh heh heh... Hold up a moment! We'll be taking those!"}

tellraw @s[scores={DialogueTrigger=42,TalkTime=53}] {"text":"<Captain Stern> Wh-what was that?! Who are you people?!"}

tellraw @s[scores={DialogueTrigger=42,TalkTime=60,GameVersion=1}] {"text":"<Team Magma Grunt> We are Team Magma!"}
tellraw @s[scores={DialogueTrigger=42,TalkTime=67,GameVersion=1}] {"text":"<Team Magma Grunt> Our boss has need of the parts in that case, so relinquish it to us at once!"}

tellraw @s[scores={DialogueTrigger=42,TalkTime=60,GameVersion=2}] {"text":"<Team Aqua Grunt> We're Team Aqua!"}
tellraw @s[scores={DialogueTrigger=42,TalkTime=67,GameVersion=2}] {"text":"<Team Aqua Grunt> Our boss wants the parts in that case, so shut your yap and fork it over!"}

execute as @s[scores={DialogueTrigger=42,TalkTime=75,GameVersion=1}] run pokebattle @s MagmaGrunt1
execute as @s[scores={DialogueTrigger=42,TalkTime=75,GameVersion=2}] run pokebattle @s AquaGrunt1

tag @s[scores={DialogueTrigger=42,TalkTime=76..}] add Dialogue42
#----------------------------
#Dialogue 43 - Slateport City
#Post-Grunt 1 Battle

clear @s[scores={DialogueTrigger=43}] minecraft:nether_brick

tellraw @s[scores={DialogueTrigger=43,TalkTime=3,GameVersion=1}] {"text":"<Team Magma Grunt> Absurd! I was defeated by this child?"}
tellraw @s[scores={DialogueTrigger=43,TalkTime=10,GameVersion=1}] {"text":"<Team Magma Grunt> This is quite disastrous. At this rate, I will become the target of the boss's fury!"}
tellraw @s[scores={DialogueTrigger=43,TalkTime=19,GameVersion=1}] ["",{"text":"<"},{"text":"Team Magma Grunt","color":"gray"},{"text":"> My, you really are incompetent..."}]
...
tellraw @s[scores={DialogueTrigger=43,TalkTime=3,GameVersion=2}] {"text":"<Team Aqua Grunt> Awaaaughhh! I got beat by a little brat?"}
tellraw @s[scores={DialogueTrigger=43,TalkTime=10,GameVersion=2}] {"text":"<Team Aqua Grunt> Oh, man, what a disaster... The boss is gonna be furious..."}
tellraw @s[scores={DialogueTrigger=43,TalkTime=19,GameVersion=2}] ["",{"text":"<"},{"text":"Team Aqua Grunt","color":"gray"},{"text":"> Hmph! Sniveling wimp!"}]
...
clear @s[scores={DialogueTrigger=44}] minecraft:nether_brick

tellraw @s[scores={DialogueTrigger=44,TalkTime=1,GameVersion=1}] {"text":"<Team Magma Grunt> How could a future Ace Grunt of Team Magma be defeated?"}
tellraw @s[scores={DialogueTrigger=44,TalkTime=9,GameVersion=1}] {"text":"<Team Magma Grunt> Wh-what should we do now? We must obtain that case at once!"}
tellraw @s[scores={DialogueTrigger=44,TalkTime=17,GameVersion=1}] {"text":"<Team Magma Grunt> Hmph... I would never have posited that a mere child would prove such an obstacle."}


tellraw @s[scores={DialogueTrigger=44,TalkTime=1,GameVersion=2}] {"text":"<Team Aqua Grunt> They beat the 27th-strongest Grunt in Team Aqua?"}
tellraw @s[scores={DialogueTrigger=44,TalkTime=9,GameVersion=2}] {"text":"<Team Aqua Grunt> N-now what? If we don't get that case, we're in for it!"}
tellraw @s[scores={DialogueTrigger=44,TalkTime=17,GameVersion=2}] {"text":"<Team Aqua Grunt> Arrgh! I never thought we'd be stopped by some meddling kid!"}

#Spawns in leader
#Shot of them
#https://youtu.be/MgkqxXCmrtI?t=12840

execute as @s[scores={DialogueTrigger=44,TalkTime=27},tag=!MusicDisabled] run stopsound @s record
execute as @s[scores={DialogueTrigger=44,TalkTime=27},tag=!MusicDisabled] run playsound minecraft:teamleader record @s ~ ~ ~ 1 1 1
execute as @s[scores={DialogueTrigger=44,TalkTime=27},tag=!MusicDisabled] run scoreboard players set @s MusicCooldown 99

execute as @s[scores={DialogueTrigger=44,TalkTime=27,GameVersion=1}] run particle cloud -1388 15 278 1 1 1 0.15 300
execute as @s[scores={DialogueTrigger=44,TalkTime=27,GameVersion=2}] run particle cloud -1388 -12 278 1 1 1 0.15 300

execute as @s[scores={DialogueTrigger=44,TalkTime=27,GameVersion=1}] run summon pixelmon:npc_chatting -1388 15 278 {HurtByTimestamp: 0, chatNum: 0, Invulnerable: 0b, FallFlying: 0b, PortalCooldown: 0, AbsorptionAmount: 0.0f, Name: "Maxie", FallDistance: 0.0f, CanUpdate: 1b, DeathTime: 0s, DefaultName: 0b, Commands: {interactCommands: []}, HandDropChances: [0.085f, 0.085f], PersistenceRequired: 1b, trainerLocation: 2, DefaultGreet: 0b, TextureIndex: 4, TrainerIndex: "madame", NameIndex: 4, Health: 20.0f, LeftHanded: 0b, Air: 300s, OnGround: 1b, Rotation: [-90.0f, 0.0f], HandItems: [{}, {}], ChatIndex: 0, Profession: -1s,Fire: -1s, ArmorItems: [{}, {}, {}, {}], CanPickUpLoot: 0b, CustomSteveTexture: "magmaboss.png", HurtTime: 0s, BaseTrainer: "Steve", Inventory: [], AIMode: 2s}
execute as @s[scores={DialogueTrigger=44,TalkTime=27,GameVersion=2}] run summon pixelmon:npc_chatting -1388 -12 278 {HurtByTimestamp: 0, chatNum: 0, Invulnerable: 0b, FallFlying: 0b, PortalCooldown: 0, AbsorptionAmount: 0.0f, Name: "Archie", FallDistance: 0.0f, CanUpdate: 1b, DeathTime: 0s, DefaultName: 0b, Commands: {interactCommands: []}, HandDropChances: [0.085f, 0.085f], PersistenceRequired: 1b, trainerLocation: 2, DefaultGreet: 0b, TextureIndex: 4, TrainerIndex: "madame", NameIndex: 4, Health: 20.0f, LeftHanded: 0b, Air: 300s, OnGround: 1b, Rotation: [-90.0f, 0.0f], HandItems: [{}, {}], ChatIndex: 0, Profession: -1s,Fire: -1s, ArmorItems: [{}, {}, {}, {}], CanPickUpLoot: 0b, CustomSteveTexture: "aquaboss.png", HurtTime: 0s, BaseTrainer: "Steve", Inventory: [], AIMode: 2s}

execute as @s[scores={DialogueTrigger=44,TalkTime=27,GameVersion=1}] run gamemode spectator
execute as @s[scores={DialogueTrigger=44,TalkTime=27,GameVersion=1}] run tp @s -1384.0 15 280.75 123 2

execute as @s[scores={DialogueTrigger=44,TalkTime=27,GameVersion=2}] run gamemode spectator
execute as @s[scores={DialogueTrigger=44,TalkTime=27,GameVersion=2}] run tp @s -1384.0 -12 280.75 123 2



#Maxie
tellraw @s[scores={DialogueTrigger=44,TalkTime=30,GameVersion=1}] {"text":"<...> Now here I was wondering how you could be held up in the simple act of seizing a case."}
tellraw @s[scores={DialogueTrigger=44,TalkTime=38,GameVersion=1}] {"text":"<...> Do I take it you are being stymied by this child?"}

execute as @s[scores={DialogueTrigger=44,TalkTime=43,GameVersion=1}] run gamemode adventure
execute as @s[scores={DialogueTrigger=44,TalkTime=43,GameVersion=1}] run tp @s -1383.5 15 278.5 90 7

execute as @s[scores={DialogueTrigger=44,TalkTime=43,GameVersion=2}] run gamemode adventure
execute as @s[scores={DialogueTrigger=44,TalkTime=43,GameVersion=2}] run tp @s -1383.5 -12 278.5 90 7

tellraw @s[scores={DialogueTrigger=44,TalkTime=45,GameVersion=43}] {"text":"<...> Hmm. Though you are but a child, your eyes tell me of your fierce determination."}
tellraw @s[scores={DialogueTrigger=44,TalkTime=54,GameVersion=1}] {"text":"<...> My heart is pounding in my chest..."}
tellraw @s[scores={DialogueTrigger=44,TalkTime=61,GameVersion=1}] {"text":"<...> Yes, I think I can see why my lowly Grunts could not stand one minute against you."}
tellraw @s[scores={DialogueTrigger=44,TalkTime=70,GameVersion=1}] {"text":"<Maxie> I am called Maxie."}
tellraw @s[scores={DialogueTrigger=44,TalkTime=77,GameVersion=1}] {"text":"<Maxie> I stand as the head of Team Magma, a noble organization whose goal is to propel humanity to even greater heights of progress and evolution."}
tellraw @s[scores={DialogueTrigger=44,TalkTime=91,GameVersion=1}] {"text":"<Maxie> Indeed."}
tellraw @s[scores={DialogueTrigger=44,TalkTime=97,GameVersion=1}] {"text":"<Maxie> And you are one of the young persons who may shape our society's future."}
tellraw @s[scores={DialogueTrigger=44,TalkTime=105,GameVersion=1}] {"text":"<Maxie> Considering that fact, I believe I shall educate you in the ways of the world."}
tellraw @s[scores={DialogueTrigger=44,TalkTime=113,GameVersion=1}] {"text":"<Maxie> The land..."}
tellraw @s[scores={DialogueTrigger=44,TalkTime=120,GameVersion=1}] {"text":"<Maxie> It is the stage upon which humanity stands."}
tellraw @s[scores={DialogueTrigger=44,TalkTime=127,GameVersion=1}] {"text":"<Maxie> The land exists so we humans might continue onward and upward, stepping into the future..."}
tellraw @s[scores={DialogueTrigger=44,TalkTime=136,GameVersion=1}] {"text":"<Maxie> For us to continue growing and evolving, humans require a grand stage upon which to stand."}
tellraw @s[scores={DialogueTrigger=44,TalkTime=145,GameVersion=1}] {"text":"<Maxie> A land upon which we can stride forward..."}
tellraw @s[scores={DialogueTrigger=44,TalkTime=152,GameVersion=1}] {"text":"<Maxie> A land we can explore...develop...exploit..."}
tellraw @s[scores={DialogueTrigger=44,TalkTime=159,GameVersion=1}] {"text":"<Maxie> This is the basis for the growth of all human endeavor."}
tellraw @s[scores={DialogueTrigger=44,TalkTime=167,GameVersion=1}] {"text":"<Maxie> That is why we, Team Magma, must increase the landmass of this world!"}
tellraw @s[scores={DialogueTrigger=44,TalkTime=175,GameVersion=1}] {"text":"<Maxie> Believe that this will lead to a future of eternal happiness for humanity..."}
tellraw @s[scores={DialogueTrigger=44,TalkTime=184,GameVersion=1}] {"text":"<Maxie> And consequently for all life!"}
tellraw @s[scores={DialogueTrigger=44,TalkTime=191,GameVersion=1}] {"text":"<Maxie> Humph. I suppose the concept may still be too difficult for a child to comprehend."}
tellraw @s[scores={DialogueTrigger=44,TalkTime=200,GameVersion=1}] {"text":"<Maxie> Is that the case?"}
tellraw @s[scores={DialogueTrigger=44,TalkTime=207,GameVersion=1}] {"text":"<Maxie> At least I have tried to open your mind."}
tellraw @s[scores={DialogueTrigger=44,TalkTime=214,GameVersion=1}] {"text":"<Maxie> I will take my leave for now."}
tellraw @s[scores={DialogueTrigger=44,TalkTime=221,GameVersion=1}] {"text":"<Maxie> I suggest you take care that you never again stand against Team Magma."}
tellraw @s[scores={DialogueTrigger=44,TalkTime=230,GameVersion=1}] {"text":"<Maxie> I will not be so lenient the next time."}
tellraw @s[scores={DialogueTrigger=44,TalkTime=237,GameVersion=1}] {"text":"<Maxie> I implore you to remember that."}
tellraw @s[scores={DialogueTrigger=44,TalkTime=243,GameVersion=1}] {"text":"<Maxie> We are done here."}
execute as @s[scores={DialogueTrigger=44,TalkTime=249,GameVersion=1}] run scoreboard players set @s TalkTime 264



#Archie
tellraw @s[scores={DialogueTrigger=44,TalkTime=43,GameVersion=2}] {"text":"<...> What do we have here?"}
tellraw @s[scores={DialogueTrigger=44,TalkTime=50,GameVersion=2}] {"text":"<...> I came to see what was taking so long just to steal a few parts, and I find you simps getting beat by this kid?"}
tellraw @s[scores={DialogueTrigger=44,TalkTime=62,GameVersion=2}] {"text":"<...> Heh! That's quite a fierce expression for such a wee little scamp."}
tellraw @s[scores={DialogueTrigger=44,TalkTime=70,GameVersion=2}] {"text":"<...> That face tells me you're not just another mindless Trainer brat."}
tellraw @s[scores={DialogueTrigger=44,TalkTime=78,GameVersion=2}] {"text":"<Archie> The name is Archie."}
tellraw @s[scores={DialogueTrigger=44,TalkTime=85,GameVersion=2}] {"text":"<Archie> The rough-looking lot you see here are members of my team—Team Aqua."}
tellraw @s[scores={DialogueTrigger=44,TalkTime=93,GameVersion=2}] {"text":"<Archie> So tell me, child..."}
tellraw @s[scores={DialogueTrigger=44,TalkTime=100,GameVersion=2}] {"text":"<Archie> Do you know that Pokémon, people, and all life in this world depend on the sea for life?"}
tellraw @s[scores={DialogueTrigger=44,TalkTime=110,GameVersion=2}] {"text":"<Archie> That's right. The sea is an irreplaceable treasure for every living thing on this planet."}
tellraw @s[scores={DialogueTrigger=44,TalkTime=120,GameVersion=2}] {"text":"<Archie> But with our selfish extravagance, humanity dirties the great ocean, destroying this source of all life..."}
tellraw @s[scores={DialogueTrigger=44,TalkTime=132,GameVersion=2}] {"text":"<Archie> Day by day, we're all destroying our most precious resource!"}
tellraw @s[scores={DialogueTrigger=44,TalkTime=140,GameVersion=2}] {"text":"<Archie> If we humans suffer from our actions, well, maybe we'll end up getting what we deserve."}
tellraw @s[scores={DialogueTrigger=44,TalkTime=149,GameVersion=2}] {"text":"<Archie> But what about the Pokémon in our world?"}
tellraw @s[scores={DialogueTrigger=44,TalkTime=156,GameVersion=2}] {"text":"<Archie> The Pokémon that no longer have a place to live because we stole and soiled their seas?"}
tellraw @s[scores={DialogueTrigger=44,TalkTime=166,GameVersion=2}] {"text":"<Archie> The Pokémon that won't have a place to raise their young and watch them grow?"}
tellraw @s[scores={DialogueTrigger=44,TalkTime=175,GameVersion=2}] {"text":"<Archie> We are creating a world in which innocent Pokémon suffer as a result of our actions..."}
tellraw @s[scores={DialogueTrigger=44,TalkTime=185,GameVersion=2}] {"text":"<Archie> And that is something that I can't forgive!"}
tellraw @s[scores={DialogueTrigger=44,TalkTime=193,GameVersion=2}] {"text":"<Archie> That's why I came to a decision, see?"}
tellraw @s[scores={DialogueTrigger=44,TalkTime=200,GameVersion=2}] {"text":"<Archie> The foolish actions of my fellow humans, the seas we have blighted, nature itself..."}
tellraw @s[scores={DialogueTrigger=44,TalkTime=209,GameVersion=2}] {"text":"<Archie> I will return everything to its unspoiled beginnings!"}
tellraw @s[scores={DialogueTrigger=44,TalkTime=216,GameVersion=2}] {"text":"<Archie> ... Heh! It's not like me to talk so much."}
tellraw @s[scores={DialogueTrigger=44,TalkTime=223,GameVersion=2}] {"text":"<Archie> Never mind, little scamp..."}
tellraw @s[scores={DialogueTrigger=44,TalkTime=230,GameVersion=2}] {"text":"<Archie> I'll withdraw for now and leave you be."}
tellraw @s[scores={DialogueTrigger=44,TalkTime=237,GameVersion=2}] {"text":"<Archie> But understand this..."}
tellraw @s[scores={DialogueTrigger=44,TalkTime=244,GameVersion=2}] {"text":"<Archie> Get in my way again, and you won't walk away unscathed next time."}
tellraw @s[scores={DialogueTrigger=44,TalkTime=252,GameVersion=2}] {"text":"<Archie> Remember that, at least!"}
tellraw @s[scores={DialogueTrigger=44,TalkTime=259,GameVersion=2}] {"text":"<Archie> We're moving out, lads!"}

#Teleports leaders/grunts out

execute as @s[scores={DialogueTrigger=44,TalkTime=265}] run function hoenn:tools/forceclick

execute as @s[scores={DialogueTrigger=44,TalkTime=265,GameVersion=1}] run particle cloud -1388 15 278 1 1 1 0.15 300
execute as @s[scores={DialogueTrigger=44,TalkTime=265,GameVersion=1}] run particle cloud -1382 15 270 1 1 1 0.15 300
execute as @s[scores={DialogueTrigger=44,TalkTime=265,GameVersion=1}] run particle cloud -1384 15 270 1 1 1 0.15 300

execute as @s[scores={DialogueTrigger=44,TalkTime=265,GameVersion=1}] run tp @e[type=pixelmon:npc_chatting,x=-1388,y=15,z=278,distance=..3] 10000000 -50000 -10000000
execute as @s[scores={DialogueTrigger=44,TalkTime=265,GameVersion=1}] run tp @e[type=pixelmon:npc_trainer,x=-1382,y=15,z=270,distance=..3] 10000000 -50000 -10000000
execute as @s[scores={DialogueTrigger=44,TalkTime=265,GameVersion=1}] run tp @e[type=pixelmon:npc_trainer,x=-1384,y=15,z=270,distance=..3] 10000000 -50000 -10000000


execute as @s[scores={DialogueTrigger=44,TalkTime=265,GameVersion=2}] run particle cloud -1388 -12 278 1 1 1 0.15 300
execute as @s[scores={DialogueTrigger=44,TalkTime=265,GameVersion=2}] run particle cloud -1382 -12 270 1 1 1 0.15 300
execute as @s[scores={DialogueTrigger=44,TalkTime=265,GameVersion=2}] run particle cloud -1384 -12 270 1 1 1 0.15 300

execute as @s[scores={DialogueTrigger=44,TalkTime=265,GameVersion=2}] run tp @e[type=pixelmon:npc_chatting,x=-1388,y=-12,z=278,distance=..3] 10000000 -50000 -10000000
execute as @s[scores={DialogueTrigger=44,TalkTime=265,GameVersion=2}] run tp @e[type=pixelmon:npc_trainer,x=-1382,y=-12,z=270,distance=..3] 10000000 -50000 -10000000
execute as @s[scores={DialogueTrigger=44,TalkTime=265,GameVersion=2}] run tp @e[type=pixelmon:npc_trainer,x=-1384,y=-12,z=270,distance=..3] 10000000 -50000 -10000000


#Teleports player to non-grunt museum if they're downstairs



tellraw @s[scores={DialogueTrigger=44,TalkTime=268}] {"text":"<Captain Stern> Young trainer..."}
tellraw @s[scores={DialogueTrigger=44,TalkTime=275}] ["",{"text":"<Captain Stern> Ah, "},{"selector":"@s"},{"text":", is it?"}]
tellraw @s[scores={DialogueTrigger=44,TalkTime=282}] {"text":"<Captain Stern> That was quite a tense situation! Thank you for helping me out!"}
tellraw @s[scores={DialogueTrigger=44,TalkTime=290}] {"text":"<Captain Stern> Oh, yes, I almost forgot that you brought the parts from Devon!"}

tellraw @s[scores={DialogueTrigger=44,TalkTime=297}] ["",{"selector":"@s","italic":true,"color":"gray"},{"text":" handed over the Devon Parts to Captain Stern.","italic":true,"color":"gray"}]
execute as @s[scores={DialogueTrigger=44,TalkTime=297}] run playsound pixelmon:pixelmon.block.pokelootobtained ambient @s ~ ~ ~ 1 1 1
execute as @s[scores={DialogueTrigger=44,TalkTime=297}] run clear @s music_disc_13

tellraw @s[scores={DialogueTrigger=44,TalkTime=304}] {"text":"<Captain Stern> This is it!"}
tellraw @s[scores={DialogueTrigger=44,TalkTime=311}] {"text":"<Captain Stern> I can't be standing around here!"}
tellraw @s[scores={DialogueTrigger=44,TalkTime=318}] {"text":"<Captain Stern> It's finally time for us to set out on our ocean-floor expedition!"}
tellraw @s[scores={DialogueTrigger=44,TalkTime=326}] {"text":"<Captain Stern> Thanks for this, and excuse me!"}

#tps out Stern
execute as @s[scores={DialogueTrigger=44,TalkTime=332,GameVersion=1}] run particle cloud -1379 15 276 1 1 1 0.15 300
execute as @s[scores={DialogueTrigger=44,TalkTime=332,GameVersion=1}] run tp @e[type=pixelmon:npc_chatting,x=-1379,y=15,z=276,distance=..3] 10000000 -50000 -10000000

execute as @s[scores={DialogueTrigger=44,TalkTime=332,GameVersion=2}] run particle cloud -1379 -12 276 1 1 1 0.15 300
execute as @s[scores={DialogueTrigger=44,TalkTime=332,GameVersion=2}] run tp @e[type=pixelmon:npc_chatting,x=-1379,y=-12,z=276,distance=..3] 10000000 -50000 -10000000

tag @s[scores={DialogueTrigger=44,TalkTime=332..}] add Dialogue44
#----------------------------------------------------------------------------------------------------------
...
#Set up grunts
execute as @s[scores={DialogueTrigger=50,TalkTime=1,GameVersion=1}] run summon pixelmon:npc_chatting -1587 69 -11 {HurtByTimestamp: 0, chatNum: 0, Invulnerable: 0b, FallFlying: 0b, PortalCooldown: 0, AbsorptionAmount: 0.0f, Name: "Magma Grunt", FallDistance: 0.0f, CanUpdate: 1b, DeathTime: 0s, DefaultName: 0b, Commands: {interactCommands: []}, HandDropChances: [0.085f, 0.085f], PersistenceRequired: 1b, trainerLocation: 2, DefaultGreet: 0b, TextureIndex: 4, TrainerIndex: "madame", NameIndex: 4, Health: 20.0f, LeftHanded: 0b, Air: 300s, OnGround: 1b, Rotation: [180.0f, 0.0f], HandItems: [{}, {}], ChatIndex: 0, Profession: -1s,Fire: -1s, ArmorItems: [{}, {}, {}, {}], CanPickUpLoot: 0b, CustomSteveTexture: "magmagruntmale.png", HurtTime: 0s, BaseTrainer: "Steve", Inventory: [], AIMode: 2s}
execute as @s[scores={DialogueTrigger=50,TalkTime=1,GameVersion=1}] run summon pixelmon:npc_chatting -1585 69 -11 {HurtByTimestamp: 0, chatNum: 0, Invulnerable: 0b, FallFlying: 0b, PortalCooldown: 0, AbsorptionAmount: 0.0f, Name: "Magma Grunt", FallDistance: 0.0f, CanUpdate: 1b, DeathTime: 0s, DefaultName: 0b, Commands: {interactCommands: []}, HandDropChances: [0.085f, 0.085f], PersistenceRequired: 1b, trainerLocation: 2, DefaultGreet: 0b, TextureIndex: 4, TrainerIndex: "madame", NameIndex: 4, Health: 20.0f, LeftHanded: 0b, Air: 300s, OnGround: 1b, Rotation: [180.0f, 0.0f], HandItems: [{}, {}], ChatIndex: 0, Profession: -1s,Fire: -1s, ArmorItems: [{}, {}, {}, {}], CanPickUpLoot: 0b, CustomSteveTexture: "magmagruntmale.png", HurtTime: 0s, BaseTrainer: "Steve", Inventory: [], AIMode: 2s}
execute as @s[scores={DialogueTrigger=50,TalkTime=1,GameVersion=1}] run summon pixelmon:npc_chatting -1583 69 -11 {HurtByTimestamp: 0, chatNum: 0, Invulnerable: 0b, FallFlying: 0b, PortalCooldown: 0, AbsorptionAmount: 0.0f, Name: "Magma Grunt", FallDistance: 0.0f, CanUpdate: 1b, DeathTime: 0s, DefaultName: 0b, Commands: {interactCommands: []}, HandDropChances: [0.085f, 0.085f], PersistenceRequired: 1b, trainerLocation: 2, DefaultGreet: 0b, TextureIndex: 4, TrainerIndex: "madame", NameIndex: 4, Health: 20.0f, LeftHanded: 0b, Air: 300s, OnGround: 1b, Rotation: [180.0f, 0.0f], HandItems: [{}, {}], ChatIndex: 0, Profession: -1s,Fire: -1s, ArmorItems: [{}, {}, {}, {}], CanPickUpLoot: 0b, CustomSteveTexture: "magmagruntmale.png", HurtTime: 0s, BaseTrainer: "Steve", Inventory: [], AIMode: 2s}
execute as @s[scores={DialogueTrigger=50,TalkTime=1,GameVersion=1}] run summon pixelmon:npc_chatting -1581 69 -11 {HurtByTimestamp: 0, chatNum: 0, Invulnerable: 0b, FallFlying: 0b, PortalCooldown: 0, AbsorptionAmount: 0.0f, Name: "Magma Grunt", FallDistance: 0.0f, CanUpdate: 1b, DeathTime: 0s, DefaultName: 0b, Commands: {interactCommands: []}, HandDropChances: [0.085f, 0.085f], PersistenceRequired: 1b, trainerLocation: 2, DefaultGreet: 0b, TextureIndex: 4, TrainerIndex: "madame", NameIndex: 4, Health: 20.0f, LeftHanded: 0b, Air: 300s, OnGround: 1b, Rotation: [180.0f, 0.0f], HandItems: [{}, {}], ChatIndex: 0, Profession: -1s,Fire: -1s, ArmorItems: [{}, {}, {}, {}], CanPickUpLoot: 0b, CustomSteveTexture: "magmagruntmale.png", HurtTime: 0s, BaseTrainer: "Steve", Inventory: [], AIMode: 2s}
execute as @s[scores={DialogueTrigger=50,TalkTime=1,GameVersion=1}] run summon pixelmon:npc_chatting -1585 69 -14 {HurtByTimestamp: 0, chatNum: 0, Invulnerable: 0b, FallFlying: 0b, PortalCooldown: 0, AbsorptionAmount: 0.0f, Name: "Magma Grunt", FallDistance: 0.0f, CanUpdate: 1b, DeathTime: 0s, DefaultName: 0b, Commands: {interactCommands: []}, HandDropChances: [0.085f, 0.085f], PersistenceRequired: 1b, trainerLocation: 2, DefaultGreet: 0b, TextureIndex: 4, TrainerIndex: "madame", NameIndex: 4, Health: 20.0f, LeftHanded: 0b, Air: 300s, OnGround: 1b, Rotation: [0.0f, 0.0f], HandItems: [{}, {}], ChatIndex: 0, Profession: -1s,Fire: -1s, ArmorItems: [{}, {}, {}, {}], CanPickUpLoot: 0b, CustomSteveTexture: "magmagruntmale.png", HurtTime: 0s, BaseTrainer: "Steve", Inventory: [], AIMode: 2s}

execute as @s[scores={DialogueTrigger=50,TalkTime=1,GameVersion=2}] run summon pixelmon:npc_chatting -1587 69 -11 {HurtByTimestamp: 0, chatNum: 0, Invulnerable: 0b, FallFlying: 0b, PortalCooldown: 0, AbsorptionAmount: 0.0f, Name: "Aqua Grunt", FallDistance: 0.0f, CanUpdate: 1b, DeathTime: 0s, DefaultName: 0b, Commands: {interactCommands: []}, HandDropChances: [0.085f, 0.085f], PersistenceRequired: 1b, trainerLocation: 2, DefaultGreet: 0b, TextureIndex: 4, TrainerIndex: "madame", NameIndex: 4, Health: 20.0f, LeftHanded: 0b, Air: 300s, OnGround: 1b, Rotation: [180.0f, 0.0f], HandItems: [{}, {}], ChatIndex: 0, Profession: -1s,Fire: -1s, ArmorItems: [{}, {}, {}, {}], CanPickUpLoot: 0b, CustomSteveTexture: "aquagruntmale.png", HurtTime: 0s, BaseTrainer: "Steve", Inventory: [], AIMode: 2s}
execute as @s[scores={DialogueTrigger=50,TalkTime=1,GameVersion=2}] run summon pixelmon:npc_chatting -1585 69 -11 {HurtByTimestamp: 0, chatNum: 0, Invulnerable: 0b, FallFlying: 0b, PortalCooldown: 0, AbsorptionAmount: 0.0f, Name: "Aqua Grunt", FallDistance: 0.0f, CanUpdate: 1b, DeathTime: 0s, DefaultName: 0b, Commands: {interactCommands: []}, HandDropChances: [0.085f, 0.085f], PersistenceRequired: 1b, trainerLocation: 2, DefaultGreet: 0b, TextureIndex: 4, TrainerIndex: "madame", NameIndex: 4, Health: 20.0f, LeftHanded: 0b, Air: 300s, OnGround: 1b, Rotation: [180.0f, 0.0f], HandItems: [{}, {}], ChatIndex: 0, Profession: -1s,Fire: -1s, ArmorItems: [{}, {}, {}, {}], CanPickUpLoot: 0b, CustomSteveTexture: "aquagruntmale.png", HurtTime: 0s, BaseTrainer: "Steve", Inventory: [], AIMode: 2s}
execute as @s[scores={DialogueTrigger=50,TalkTime=1,GameVersion=2}] run summon pixelmon:npc_chatting -1583 69 -11 {HurtByTimestamp: 0, chatNum: 0, Invulnerable: 0b, FallFlying: 0b, PortalCooldown: 0, AbsorptionAmount: 0.0f, Name: "Aqua Grunt", FallDistance: 0.0f, CanUpdate: 1b, DeathTime: 0s, DefaultName: 0b, Commands: {interactCommands: []}, HandDropChances: [0.085f, 0.085f], PersistenceRequired: 1b, trainerLocation: 2, DefaultGreet: 0b, TextureIndex: 4, TrainerIndex: "madame", NameIndex: 4, Health: 20.0f, LeftHanded: 0b, Air: 300s, OnGround: 1b, Rotation: [180.0f, 0.0f], HandItems: [{}, {}], ChatIndex: 0, Profession: -1s,Fire: -1s, ArmorItems: [{}, {}, {}, {}], CanPickUpLoot: 0b, CustomSteveTexture: "aquagruntmale.png", HurtTime: 0s, BaseTrainer: "Steve", Inventory: [], AIMode: 2s}
execute as @s[scores={DialogueTrigger=50,TalkTime=1,GameVersion=2}] run summon pixelmon:npc_chatting -1581 69 -11 {HurtByTimestamp: 0, chatNum: 0, Invulnerable: 0b, FallFlying: 0b, PortalCooldown: 0, AbsorptionAmount: 0.0f, Name: "Aqua Grunt", FallDistance: 0.0f, CanUpdate: 1b, DeathTime: 0s, DefaultName: 0b, Commands: {interactCommands: []}, HandDropChances: [0.085f, 0.085f], PersistenceRequired: 1b, trainerLocation: 2, DefaultGreet: 0b, TextureIndex: 4, TrainerIndex: "madame", NameIndex: 4, Health: 20.0f, LeftHanded: 0b, Air: 300s, OnGround: 1b, Rotation: [180.0f, 0.0f], HandItems: [{}, {}], ChatIndex: 0, Profession: -1s,Fire: -1s, ArmorItems: [{}, {}, {}, {}], CanPickUpLoot: 0b, CustomSteveTexture: "aquagruntmale.png", HurtTime: 0s, BaseTrainer: "Steve", Inventory: [], AIMode: 2s}
execute as @s[scores={DialogueTrigger=50,TalkTime=1,GameVersion=2}] run summon pixelmon:npc_chatting -1585 69 -14 {HurtByTimestamp: 0, chatNum: 0, Invulnerable: 0b, FallFlying: 0b, PortalCooldown: 0, AbsorptionAmount: 0.0f, Name: "Aqua Grunt", FallDistance: 0.0f, CanUpdate: 1b, DeathTime: 0s, DefaultName: 0b, Commands: {interactCommands: []}, HandDropChances: [0.085f, 0.085f], PersistenceRequired: 1b, trainerLocation: 2, DefaultGreet: 0b, TextureIndex: 4, TrainerIndex: "madame", NameIndex: 4, Health: 20.0f, LeftHanded: 0b, Air: 300s, OnGround: 1b, Rotation: [0.0f, 0.0f], HandItems: [{}, {}], ChatIndex: 0, Profession: -1s,Fire: -1s, ArmorItems: [{}, {}, {}, {}], CanPickUpLoot: 0b, CustomSteveTexture: "aquagruntmale.png", HurtTime: 0s, BaseTrainer: "Steve", Inventory: [], AIMode: 2s}


execute as @s[scores={DialogueTrigger=50,TalkTime=6}] run gamemode spectator
execute as @s[scores={DialogueTrigger=50,TalkTime=6}] run tp @s -1579.0 74.15 -3.5 153 33

tellraw @s[scores={DialogueTrigger=50,TalkTime=7,GameVersion=1}] {"text":"<Team Magma Grunt> Let's keep going through Route 110 and head for Mt. Chimney!"}
tellraw @s[scores={DialogueTrigger=50,TalkTime=14,GameVersion=1}] {"text":"<Team Magma Grunt 3> It'll be quite a long journey."}
tellraw @s[scores={DialogueTrigger=50,TalkTime=21,GameVersion=1}] {"text":"<Team Magma Grunt 2> Let's take a rest in Mauville City, which is on the way."}

tellraw @s[scores={DialogueTrigger=50,TalkTime=29,GameVersion=1}] {"text":"<Team Magma Grunt> I concur!"}


tellraw @s[scores={DialogueTrigger=50,TalkTime=7,GameVersion=2}] {"text":"<Team Aqua Grunt> Let's keep going through Route 110 and head for Mt. Chimney!"}
tellraw @s[scores={DialogueTrigger=50,TalkTime=14,GameVersion=2}] {"text":"<Team Aqua Grunt 3> Wow, that's quite far."}
tellraw @s[scores={DialogueTrigger=50,TalkTime=21,GameVersion=2}] {"text":"<Team Aqua Grunt 2> Why don't we take a rest in Mauville City. It's on the way."}

tellraw @s[scores={DialogueTrigger=50,TalkTime=29,GameVersion=2}] {"text":"<Team Aqua Grunt> Great idea!"}
...
#tps grunts out
execute as @s[scores={DialogueTrigger=50,TalkTime=38}] run tp @e[x=-1594,y=68,z=-42,dx=23,dy=5,dz=35,type=pixelmon:npc_chatting] 10000000 -50000 -10000000
execute as @s[scores={DialogueTrigger=50,TalkTime=38}] run gamemode adventure
execute as @s[scores={DialogueTrigger=50,TalkTime=38}] run tp @s -1584 69 5 180 7

tag @s[scores={DialogueTrigger=50,TalkTime=38..}] add Dialogue50
#----------------------------------------------------------------------------------------------------------
#Dialogue 51-56
...
execute at @s[scores={DialogueTrigger=58,TalkTime=1}] as @e[type=pixelmon:npc_chatting,distance=..10] at @s run tp @s ~ ~ ~ facing entity @p[distance=..15]

execute as @s[scores={DialogueTrigger=58,TalkTime=1},tag=!MusicDisabled] run stopsound @s record
execute as @s[scores={DialogueTrigger=58,TalkTime=1},tag=!MusicDisabled] run playsound may record @s ~ ~ ~ 1 1 1
execute as @s[scores={DialogueTrigger=58,TalkTime=1},tag=!MusicDisabled] run scoreboard players set @s MusicCooldown 102

tellraw @s[scores={DialogueTrigger=58,TalkTime=3,Rival=1}] ["",{"text":"<May> Hey, "},{"selector":"@s"},{"text":"! It's been ages!"}]
tellraw @s[scores={DialogueTrigger=58,TalkTime=10,Rival=1}] {"text":"<May> Nice timing, too. I was just searching for Pokémon, you know?"}
tellraw @s[scores={DialogueTrigger=58,TalkTime=18,Rival=1}] {"text":"<May> My dad is always going on about how nature used to be even more diverse, way back in the day."}
tellraw @s[scores={DialogueTrigger=58,TalkTime=27,Rival=1}] {"text":"<May> He says that there used to be way more kinds of Pokémon than there are now!"}
tellraw @s[scores={DialogueTrigger=58,TalkTime=35,Rival=1}] {"text":"<May> So that's why we do fieldwork, him and me."}
tellraw @s[scores={DialogueTrigger=58,TalkTime=42,Rival=1}] {"text":"<May> We really want to find out what happened to those Pokémon in the past."}
tellraw @s[scores={DialogueTrigger=58,TalkTime=50,Rival=1}] {"text":"<May> On my journey up to now, I've met a lot of different Pokémon, and I think I've gotten to understand a lot of them, too."}
tellraw @s[scores={DialogueTrigger=58,TalkTime=60,Rival=1}] {"text":"<May> Me and my Pokémon have really grown."}
tellraw @s[scores={DialogueTrigger=58,TalkTime=67,Rival=1}] {"text":"<May> So..."}
tellraw @s[scores={DialogueTrigger=58,TalkTime=73,Rival=1}] {"text":"<May> How about a little battle?"}

execute as @s[scores={DialogueTrigger=58,TalkTime=78,Rival=1}] run tp @e[type=pixelmon:npc_chatting,x=-1419,y=68,z=-133,distance=..3] 10000000 -50000 -10000000
execute as @s[scores={DialogueTrigger=58,TalkTime=78,Rival=1,StarterPick=1}] run summon pixelmon:npc_trainer -1419 69 -133 {Brain: {memories: {}}, HurtByTimestamp: 0, NPCLevel: 5, RaiseToCap: 0b, TeamSelectTime: 0, LevelCap: 100, Attributes: [{Base: 0.08d, Name: "forge:entity_gravity"}, {Base: 0.0d, Name: "forge:step_height_addition"}, {Base: 0.699999988079071d, Name: "minecraft:generic.movement_speed"}], BattleType: 0, Invulnerable: 0b, AbsorptionAmount: 0.0f, DefaultLose: 0b, Name: "May", FallDistance: 0.0f, WinningsTag: {item0: {id: "minecraft:nether_brick", Count: 1b}}, CanUpdate: 1b, BossTier: "notboss", DefaultName: 1b, hasMegaItem: 0, TeamPreview: 0b, HandDropChances: [0.085f, 0.085f], PersistenceRequired: 1b, FullHeal: 0b, trainerLocation: 2, oldGen: 0, OldGen: 0, pokeStore: {party1: {EVSpeed: 0s, StatsDefense: 28s, IVAttack: 21b, Growth: 2b, PHiddenAbility: 0b, Moveset: [{MoveID: "Stun Spore", MovePP: 30b}, {MoveID: "Leech Seed", MovePP: 10b}, {MoveID: "Mega Drain", MovePP: 15b}, {MoveID: "Headbutt", MovePP: 15b}], PersistentData: {}, Gender: 0b, GigantamaxFactor: 0b, Friendship: 70s, eggCycles: -1, EVAttack: 0s, StatsSpecialAttack: 19s, IVSpDef: 12b, CaughtBall: "poke_ball", IVHP: 15b, EVHP: 0s, ndex: 285, palette: "none", StatsSpecialDefense: 28s, Nature: 7b, Ability: "EffectSpore", StatsHP: 52s, IVDefense: 11b, Health: 52, SpecFlags: [], DoesLevel: 1b, EVDefense: 0s, PAbilitySlot: 0, DynamaxLevel: 0, Variant: "", StatsSpeed: 20s, EVSpecialAttack: 0s, StatsAttack: 25s, IVSpeed: 17b, Level: 18, IVSpAtt: 15b, NBT_VERSION: 2b, EVSpecialDefense: 0s, EXP: 0, RelrnMoves: [], ribbons2: []}, party0: {EVSpeed: 0s, StatsDefense: 17s, IVAttack: 13b, Growth: 4b, PHiddenAbility: 0b, Moveset: [{MoveID: "Water Gun", MovePP: 25b}, {MoveID: "Rollout", MovePP: 20b}, {MoveID: "Whirlpool", MovePP: 15b}, {MoveID: "Astonish", MovePP: 15b}], PersistentData: {}, Gender: 0b, GigantamaxFactor: 0b, Friendship: 70s, eggCycles: -1, EVAttack: 0s, StatsSpecialAttack: 38s, IVSpDef: 2b, CaughtBall: "poke_ball", IVHP: 22b, EVHP: 0s, ndex: 320, palette: "none", StatsSpecialDefense: 17s, Nature: 18b, Ability: "Oblivious", StatsHP: 78s, IVDefense: 10b, Health: 78, SpecFlags: [], DoesLevel: 1b, EVDefense: 0s, PAbilitySlot: 1, DynamaxLevel: 0, Variant: "", StatsSpeed: 31s, EVSpecialAttack: 0s, StatsAttack: 32s, IVSpeed: 26b, Level: 18, IVSpAtt: 28b, NBT_VERSION: 2b, EVSpecialDefense: 0s, EXP: 0, RelrnMoves: [], ribbons2: []}, party2: {EVSpeed: 0s, StatsDefense: 31s, IVAttack: 9b, Growth: 1b, PHiddenAbility: 0b, Moveset: [{MoveID: "Sand Attack", MovePP: 15b}, {MoveID: "Peck", MovePP: 35b}, {MoveID: "Double Kick", MovePP: 30b}, {MoveID: "Flame Charge", MovePP: 20b}], PersistentData: {}, Gender: 1b, GigantamaxFactor: 0b, Friendship: 70s, eggCycles: -1, EVAttack: 0s, StatsSpecialAttack: 49s, IVSpDef: 23b, CaughtBall: "poke_ball", IVHP: 21b, EVHP: 0s, ndex: 256, palette: "none", StatsSpecialDefense: 29s, Nature: 20b, Ability: "Blaze", StatsHP: 58s, IVDefense: 14b, Health: 58, SpecFlags: [], DoesLevel: 1b, EVDefense: 0s, PAbilitySlot: 0, DynamaxLevel: 0, Variant: "", StatsSpeed: 29s, EVSpecialAttack: 0s, StatsAttack: 40s, IVSpeed: 14b, Level: 20, IVSpAtt: 30b, NBT_VERSION: 2b, EVSpecialDefense: 0s, EXP: 0, RelrnMoves: [], ribbons2: []}, TempPartyEnabled: 0b}, EncMode: 1s, Air: 300s, HandItems: [{}, {}], ArmorDropChances: [0.085f, 0.085f, 0.085f, 0.085f], Profession: -1s, CanPickUpLoot: 0b, HurtTime: 0s, Inventory: [], DefaultWin: 0b, WinMessage: "Yikes! You're better than I expected!", Greeting: "How about a little battle?", Exitable: 1b, TrainerRotation: 0.0f, Encounters: [], FallFlying: 0b, PortalCooldown: 0, TurnTime: 0, DeathTime: 0s, Commands: {winCommands: [], loseCommands: [], preBattleCommands: [], interactCommands: [], forfeitCommands: []}, GymLeader: 0b, EngageDistance: 10, DefaultGreet: 0b, Motion: [0.0d, -0.0784000015258789d, 0.0d], TextureIndex: 4, TrainerIndex: "steve", Health: 20.0f, BattleAIMode: 0s, LoseMessage: "Yay, I win!", LeftHanded: 0b, OnGround: 1b, Rotation: [0.0f, 0.0f], ChatIndex: 0, Fire: -1s, ArmorItems: [{}, {}, {}, {}], CustomSteveTexture: "may", NumPokemon: 6, BaseTrainer: "Steve", WinMoney: 800, AIMode: 1s}
execute as @s[scores={DialogueTrigger=58,TalkTime=78,Rival=1,StarterPick=2}] run summon pixelmon:npc_trainer -1419 69 -133 {Brain: {memories: {}}, HurtByTimestamp: 0, NPCLevel: 5, RaiseToCap: 0b, TeamSelectTime: 0, LevelCap: 100, Attributes: [{Base: 0.08d, Name: "forge:entity_gravity"}, {Base: 0.0d, Name: "forge:step_height_addition"}, {Base: 0.699999988079071d, Name: "minecraft:generic.movement_speed"}], BattleType: 0, Invulnerable: 0b, AbsorptionAmount: 0.0f, DefaultLose: 0b, Name: "May", FallDistance: 0.0f, WinningsTag: {item0: {id: "minecraft:nether_brick", Count: 1b}}, CanUpdate: 1b, BossTier: "notboss", DefaultName: 1b, hasMegaItem: 0, TeamPreview: 0b, HandDropChances: [0.085f, 0.085f], PersistenceRequired: 1b, FullHeal: 0b, trainerLocation: 2, oldGen: 0, OldGen: 0, pokeStore: {party1: {EVSpeed: 0s, StatsDefense: 19s, IVAttack: 1b, Growth: 3b, PHiddenAbility: 0b, Moveset: [{MoveID: "Ember", MovePP: 25b}, {MoveID: "Rock Throw", MovePP: 15b}, {MoveID: "Harden", MovePP: 30b}, {MoveID: "Incinerate", MovePP: 15b}], PersistentData: {}, Gender: 0b, GigantamaxFactor: 0b, Friendship: 70s, eggCycles: -1, EVAttack: 0s, StatsSpecialAttack: 30s, IVSpDef: 6b, CaughtBall: "poke_ball", IVHP: 5b, EVHP: 0s, ndex: 218, palette: "none", StatsSpecialDefense: 20s, Nature: 14b, Ability: "FlameBody", StatsHP: 43s, IVDefense: 18b, Health: 43, SpecFlags: [], DoesLevel: 1b, EVDefense: 0s, PAbilitySlot: 1, DynamaxLevel: 0, Variant: "", StatsSpeed: 18s, EVSpecialAttack: 0s, StatsAttack: 19s, IVSpeed: 27b, Level: 18, IVSpAtt: 1b, NBT_VERSION: 2b, EVSpecialDefense: 0s, EXP: 0, RelrnMoves: [], ribbons2: []}, party0: {EVSpeed: 0s, StatsDefense: 27s, IVAttack: 23b, Growth: 2b, PHiddenAbility: 0b, Moveset: [{MoveID: "Stun Spore", MovePP: 30b}, {MoveID: "Leech Seed", MovePP: 10b}, {MoveID: "Mega Drain", MovePP: 15b}, {MoveID: "Headbutt", MovePP: 15b}], PersistentData: {}, Gender: 1b, GigantamaxFactor: 0b, Friendship: 70s, eggCycles: -1, EVAttack: 0s, StatsSpecialAttack: 19s, IVSpDef: 8b, CaughtBall: "poke_ball", IVHP: 0b, EVHP: 0s, ndex: 285, palette: "none", StatsSpecialDefense: 28s, Nature: 2b, Ability: "PoisonHeal", StatsHP: 49s, IVDefense: 6b, Health: 49, SpecFlags: [], DoesLevel: 1b, EVDefense: 0s, PAbilitySlot: 1, DynamaxLevel: 0, Variant: "", StatsSpeed: 19s, EVSpecialAttack: 0s, StatsAttack: 23s, IVSpeed: 13b, Level: 18, IVSpAtt: 2b, NBT_VERSION: 2b, EVSpecialDefense: 0s, EXP: 0, RelrnMoves: [], ribbons2: []}, party2: {EVSpeed: 0s, StatsDefense: 39s, IVAttack: 11b, Growth: 3b, PHiddenAbility: 0b, Moveset: [{MoveID: "Mud-Slap", MovePP: 10b}, {MoveID: "Foresight", MovePP: 40b}, {MoveID: "Mud Bomb", MovePP: 10b}, {MoveID: "Bide", MovePP: 10b}], PersistentData: {}, Gender: 1b, GigantamaxFactor: 0b, Friendship: 70s, eggCycles: -1, EVAttack: 0s, StatsSpecialAttack: 31s, IVSpDef: 4b, CaughtBall: "poke_ball", IVHP: 3b, EVHP: 0s, ndex: 259, palette: "none", StatsSpecialDefense: 33s, Nature: 9b, Ability: "Torrent", StatsHP: 58s, IVDefense: 17b, Health: 58, SpecFlags: [], DoesLevel: 1b, EVDefense: 0s, PAbilitySlot: 0, DynamaxLevel: 0, Variant: "", StatsSpeed: 25s, EVSpecialAttack: 0s, StatsAttack: 36s, IVSpeed: 3b, Level: 20, IVSpAtt: 11b, NBT_VERSION: 2b, EVSpecialDefense: 0s, EXP: 0, RelrnMoves: [], ribbons2: []}, TempPartyEnabled: 0b}, EncMode: 1s, Air: 300s, HandItems: [{}, {}], ArmorDropChances: [0.085f, 0.085f, 0.085f, 0.085f], Profession: -1s, CanPickUpLoot: 0b, HurtTime: 0s, Inventory: [], DefaultWin: 0b, WinMessage: "Yikes! You're better than I expected!", Greeting: "How about a little battle?", Exitable: 1b, TrainerRotation: 0.0f, Encounters: [], FallFlying: 0b, PortalCooldown: 0, TurnTime: 0, DeathTime: 0s, Commands: {winCommands: [], loseCommands: [], preBattleCommands: [], interactCommands: [], forfeitCommands: []}, GymLeader: 0b, EngageDistance: 10, DefaultGreet: 0b, Motion: [0.0d, -0.0784000015258789d, 0.0d], TextureIndex: 4, TrainerIndex: "steve", Health: 20.0f, BattleAIMode: 0s, LoseMessage: "Yay, I win!", LeftHanded: 0b, OnGround: 1b, Rotation: [0.0f, 0.0f], ChatIndex: 0, Fire: -1s, ArmorItems: [{}, {}, {}, {}], CustomSteveTexture: "may", NumPokemon: 6, BaseTrainer: "Steve", WinMoney: 800, AIMode: 1s}
execute as @s[scores={DialogueTrigger=58,TalkTime=78,Rival=1,StarterPick=3}] run summon pixelmon:npc_trainer -1419 69 -133 {Brain: {memories: {}}, HurtByTimestamp: 0, NPCLevel: 5, RaiseToCap: 0b, TeamSelectTime: 0, LevelCap: 100, Attributes: [{Base: 0.08d, Name: "forge:entity_gravity"}, {Base: 0.0d, Name: "forge:step_height_addition"}, {Base: 0.699999988079071d, Name: "minecraft:generic.movement_speed"}], BattleType: 0, Invulnerable: 0b, AbsorptionAmount: 0.0f, DefaultLose: 0b, Name: "May", FallDistance: 0.0f, WinningsTag: {item0: {id: "minecraft:nether_brick", Count: 1b}}, CanUpdate: 1b, BossTier: "notboss", DefaultName: 1b, hasMegaItem: 0, TeamPreview: 0b, HandDropChances: [0.085f, 0.085f], PersistenceRequired: 1b, FullHeal: 0b, trainerLocation: 2, oldGen: 0, OldGen: 0, pokeStore: {party1: {EVSpeed: 0s, StatsDefense: 18s, IVAttack: 5b, Growth: 2b, PHiddenAbility: 0b, Moveset: [{MoveID: "Water Gun", MovePP: 25b}, {MoveID: "Rollout", MovePP: 20b}, {MoveID: "Whirlpool", MovePP: 15b}, {MoveID: "Astonish", MovePP: 15b}], PersistentData: {}, Gender: 0b, GigantamaxFactor: 0b, Friendship: 70s, eggCycles: -1, EVAttack: 0s, StatsSpecialAttack: 29s, IVSpDef: 3b, CaughtBall: "poke_ball", IVHP: 16b, EVHP: 0s, ndex: 320, palette: "none", StatsSpecialDefense: 19s, Nature: 24b, Ability: "WaterVeil", StatsHP: 77s, IVDefense: 4b, Health: 77, SpecFlags: [], DoesLevel: 1b, EVDefense: 0s, PAbilitySlot: 0, DynamaxLevel: 0, Variant: "", StatsSpeed: 27s, EVSpecialAttack: 0s, StatsAttack: 31s, IVSpeed: 7b, Level: 18, IVSpAtt: 20b, NBT_VERSION: 2b, EVSpecialDefense: 0s, EXP: 0, RelrnMoves: [], ribbons2: []}, party0: {EVSpeed: 0s, StatsDefense: 24s, IVAttack: 14b, Growth: 2b, PHiddenAbility: 0b, Moveset: [{MoveID: "Ember", MovePP: 25b}, {MoveID: "Rock Throw", MovePP: 15b}, {MoveID: "Harden", MovePP: 30b}, {MoveID: "Incinerate", MovePP: 15b}], PersistentData: {}, Gender: 1b, GigantamaxFactor: 0b, Friendship: 70s, eggCycles: -1, EVAttack: 0s, StatsSpecialAttack: 33s, IVSpDef: 26b, CaughtBall: "poke_ball", IVHP: 30b, EVHP: 0s, ndex: 218, palette: "none", StatsSpecialDefense: 24s, Nature: 1b, Ability: "FlameBody", StatsHP: 47s, IVDefense: 26b, Health: 47, SpecFlags: [], DoesLevel: 1b, EVDefense: 0s, PAbilitySlot: 1, DynamaxLevel: 0, Variant: "", StatsSpeed: 15s, EVSpecialAttack: 0s, StatsAttack: 21s, IVSpeed: 17b, Level: 18, IVSpAtt: 21b, NBT_VERSION: 2b, EVSpecialDefense: 0s, EXP: 0, RelrnMoves: [], ribbons2: []}, party2: {EVSpeed: 0s, StatsDefense: 25s, IVAttack: 11b, Growth: 3b, PHiddenAbility: 0b, Moveset: [{MoveID: "Quick Attack", MovePP: 30b}, {MoveID: "Mega Drain", MovePP: 15b}, {MoveID: "Fury Cutter", MovePP: 20b}, {MoveID: "Pursuit", MovePP: 20b}], PersistentData: {}, Gender: 0b, GigantamaxFactor: 0b, Friendship: 70s, eggCycles: -1, EVAttack: 0s, StatsSpecialAttack: 43s, IVSpDef: 10b, CaughtBall: "poke_ball", IVHP: 26b, EVHP: 0s, ndex: 253, palette: "none", StatsSpecialDefense: 33s, Nature: 13b, Ability: "Overgrow", StatsHP: 55s, IVDefense: 13b, Health: 55, SpecFlags: [], DoesLevel: 1b, EVDefense: 0s, PAbilitySlot: 0, DynamaxLevel: 0, Variant: "", StatsSpeed: 50s, EVSpecialAttack: 0s, StatsAttack: 29s, IVSpeed: 18b, Level: 20, IVSpAtt: 21b, NBT_VERSION: 2b, EVSpecialDefense: 0s, EXP: 0, RelrnMoves: [], ribbons2: []}, TempPartyEnabled: 0b}, EncMode: 1s, Air: 300s, HandItems: [{}, {}], ArmorDropChances: [0.085f, 0.085f, 0.085f, 0.085f], Profession: -1s, CanPickUpLoot: 0b, HurtTime: 0s, Inventory: [], DefaultWin: 0b, WinMessage: "Yikes! You're better than I expected!", Greeting: "How about a little battle?", Exitable: 1b, TrainerRotation: 0.0f, Encounters: [], FallFlying: 0b, PortalCooldown: 0, TurnTime: 0, DeathTime: 0s, Commands: {winCommands: [], loseCommands: [], preBattleCommands: [], interactCommands: [], forfeitCommands: []}, GymLeader: 0b, EngageDistance: 10, DefaultGreet: 0b, Motion: [0.0d, -0.0784000015258789d, 0.0d], TextureIndex: 4, TrainerIndex: "steve", Health: 20.0f, BattleAIMode: 0s, LoseMessage: "Yay, I win!", LeftHanded: 0b, OnGround: 1b, Rotation: [0.0f, 0.0f], ChatIndex: 0, Fire: -1s, ArmorItems: [{}, {}, {}, {}], CustomSteveTexture: "may", NumPokemon: 6, BaseTrainer: "Steve", WinMoney: 800, AIMode: 1s}


tellraw @s[scores={DialogueTrigger=58,TalkTime=3,Rival=2}] ["",{"text":"<Brendan> Hey, "},{"selector":"@s"},{"text":". So this is where you've been."}]
tellraw @s[scores={DialogueTrigger=58,TalkTime=10,Rival=2}] {"text":"<Brendan> How've things been going?"}
tellraw @s[scores={DialogueTrigger=58,TalkTime=17,Rival=2}] {"text":"<Brendan> I was just checking out the Pokémon around here to help with my dad's research."}
tellraw @s[scores={DialogueTrigger=58,TalkTime=25,Rival=2}] {"text":"<Brendan> He says that a long, long time ago, nature used to be way more diverse and there were lots more kinds of Pokémon, too."}
tellraw @s[scores={DialogueTrigger=58,TalkTime=35,Rival=2}] {"text":"<Brendan> My dad and I want to learn more about those Pokémon from the past, you know?"}
tellraw @s[scores={DialogueTrigger=58,TalkTime=44,Rival=2}] {"text":"<Brendan> That's why we do fieldwork. And this journey has really helped."}
tellraw @s[scores={DialogueTrigger=58,TalkTime=52,Rival=2}] {"text":"<Brendan> I've met a lot of Pokémon on my way here and learned about them, too."}
tellraw @s[scores={DialogueTrigger=58,TalkTime=60,Rival=2}] {"text":"<Brendan> Which reminds me!"}
tellraw @s[scores={DialogueTrigger=58,TalkTime=67,Rival=2}] {"text":"<Brendan> Come on! It's the first time we've met in ages, so let's have a battle!"}
tellraw @s[scores={DialogueTrigger=58,TalkTime=75,Rival=2}] ["",{"text":"<Brendan> Show me what you and your team have accomplished on your journey, "},{"selector":"@s"},{"text":"!"}]

execute as @s[scores={DialogueTrigger=58,TalkTime=83,Rival=2}] run tp @e[type=pixelmon:npc_chatting,x=-1419,y=68,z=-133,distance=..3] 10000000 -50000 -10000000
execute as @s[scores={DialogueTrigger=58,TalkTime=83,Rival=2,StarterPick=1}] run summon pixelmon:npc_trainer -1419 69 -133 {Brain: {memories: {}}, HurtByTimestamp: 0, NPCLevel: 5, RaiseToCap: 0b, TeamSelectTime: 0, LevelCap: 100, Attributes: [{Base: 0.08d, Name: "forge:entity_gravity"}, {Base: 0.0d, Name: "forge:step_height_addition"}, {Base: 0.699999988079071d, Name: "minecraft:generic.movement_speed"}], BattleType: 0, Invulnerable: 0b, AbsorptionAmount: 0.0f, DefaultLose: 0b, Name: "brendan", FallDistance: 0.0f, WinningsTag: {item0: {id: "minecraft:nether_brick", Count: 1b}}, CanUpdate: 1b, BossTier: "notboss", DefaultName: 1b, hasMegaItem: 0, TeamPreview: 0b, HandDropChances: [0.085f, 0.085f], PersistenceRequired: 1b, FullHeal: 0b, trainerLocation: 2, oldGen: 0, OldGen: 0, pokeStore: {party1: {EVSpeed: 0s, StatsDefense: 28s, IVAttack: 21b, Growth: 2b, PHiddenAbility: 0b, Moveset: [{MoveID: "Stun Spore", MovePP: 30b}, {MoveID: "Leech Seed", MovePP: 10b}, {MoveID: "Mega Drain", MovePP: 15b}, {MoveID: "Headbutt", MovePP: 15b}], PersistentData: {}, Gender: 0b, GigantamaxFactor: 0b, Friendship: 70s, eggCycles: -1, EVAttack: 0s, StatsSpecialAttack: 19s, IVSpDef: 12b, CaughtBall: "poke_ball", IVHP: 15b, EVHP: 0s, ndex: 285, palette: "none", StatsSpecialDefense: 28s, Nature: 7b, Ability: "EffectSpore", StatsHP: 52s, IVDefense: 11b, Health: 52, SpecFlags: [], DoesLevel: 1b, EVDefense: 0s, PAbilitySlot: 0, DynamaxLevel: 0, Variant: "", StatsSpeed: 20s, EVSpecialAttack: 0s, StatsAttack: 25s, IVSpeed: 17b, Level: 18, IVSpAtt: 15b, NBT_VERSION: 2b, EVSpecialDefense: 0s, EXP: 0, RelrnMoves: [], ribbons2: []}, party0: {EVSpeed: 0s, StatsDefense: 17s, IVAttack: 13b, Growth: 4b, PHiddenAbility: 0b, Moveset: [{MoveID: "Water Gun", MovePP: 25b}, {MoveID: "Rollout", MovePP: 20b}, {MoveID: "Whirlpool", MovePP: 15b}, {MoveID: "Astonish", MovePP: 15b}], PersistentData: {}, Gender: 0b, GigantamaxFactor: 0b, Friendship: 70s, eggCycles: -1, EVAttack: 0s, StatsSpecialAttack: 38s, IVSpDef: 2b, CaughtBall: "poke_ball", IVHP: 22b, EVHP: 0s, ndex: 320, palette: "none", StatsSpecialDefense: 17s, Nature: 18b, Ability: "Oblivious", StatsHP: 78s, IVDefense: 10b, Health: 78, SpecFlags: [], DoesLevel: 1b, EVDefense: 0s, PAbilitySlot: 1, DynamaxLevel: 0, Variant: "", StatsSpeed: 31s, EVSpecialAttack: 0s, StatsAttack: 32s, IVSpeed: 26b, Level: 18, IVSpAtt: 28b, NBT_VERSION: 2b, EVSpecialDefense: 0s, EXP: 0, RelrnMoves: [], ribbons2: []}, party2: {EVSpeed: 0s, StatsDefense: 31s, IVAttack: 9b, Growth: 1b, PHiddenAbility: 0b, Moveset: [{MoveID: "Sand Attack", MovePP: 15b}, {MoveID: "Peck", MovePP: 35b}, {MoveID: "Double Kick", MovePP: 30b}, {MoveID: "Flame Charge", MovePP: 20b}], PersistentData: {}, Gender: 1b, GigantamaxFactor: 0b, Friendship: 70s, eggCycles: -1, EVAttack: 0s, StatsSpecialAttack: 49s, IVSpDef: 23b, CaughtBall: "poke_ball", IVHP: 21b, EVHP: 0s, ndex: 256, palette: "none", StatsSpecialDefense: 29s, Nature: 20b, Ability: "Blaze", StatsHP: 58s, IVDefense: 14b, Health: 58, SpecFlags: [], DoesLevel: 1b, EVDefense: 0s, PAbilitySlot: 0, DynamaxLevel: 0, Variant: "", StatsSpeed: 29s, EVSpecialAttack: 0s, StatsAttack: 40s, IVSpeed: 14b, Level: 20, IVSpAtt: 30b, NBT_VERSION: 2b, EVSpecialDefense: 0s, EXP: 0, RelrnMoves: [], ribbons2: []}, TempPartyEnabled: 0b}, EncMode: 1s, Air: 300s, HandItems: [{}, {}], ArmorDropChances: [0.085f, 0.085f, 0.085f, 0.085f], Profession: -1s, CanPickUpLoot: 0b, HurtTime: 0s, Inventory: [], DefaultWin: 0b, WinMessage: "Yikes! You're better than I expected!", Greeting: "How about a little battle?", Exitable: 1b, TrainerRotation: 0.0f, Encounters: [], FallFlying: 0b, PortalCooldown: 0, TurnTime: 0, DeathTime: 0s, Commands: {winCommands: [], loseCommands: [], preBattleCommands: [], interactCommands: [], forfeitCommands: []}, GymLeader: 0b, EngageDistance: 10, DefaultGreet: 0b, Motion: [0.0d, -0.0784000015258789d, 0.0d], TextureIndex: 4, TrainerIndex: "steve", Health: 20.0f, BattleAIMode: 0s, LoseMessage: "Yay, I win!", LeftHanded: 0b, OnGround: 1b, Rotation: [0.0f, 0.0f], ChatIndex: 0, Fire: -1s, ArmorItems: [{}, {}, {}, {}], CustomSteveTexture: "brendan", NumPokemon: 6, BaseTrainer: "Steve", WinMoney: 800, AIMode: 1s}
execute as @s[scores={DialogueTrigger=58,TalkTime=83,Rival=2,StarterPick=2}] run summon pixelmon:npc_trainer -1419 69 -133 {Brain: {memories: {}}, HurtByTimestamp: 0, NPCLevel: 5, RaiseToCap: 0b, TeamSelectTime: 0, LevelCap: 100, Attributes: [{Base: 0.08d, Name: "forge:entity_gravity"}, {Base: 0.0d, Name: "forge:step_height_addition"}, {Base: 0.699999988079071d, Name: "minecraft:generic.movement_speed"}], BattleType: 0, Invulnerable: 0b, AbsorptionAmount: 0.0f, DefaultLose: 0b, Name: "brendan", FallDistance: 0.0f, WinningsTag: {item0: {id: "minecraft:nether_brick", Count: 1b}}, CanUpdate: 1b, BossTier: "notboss", DefaultName: 1b, hasMegaItem: 0, TeamPreview: 0b, HandDropChances: [0.085f, 0.085f], PersistenceRequired: 1b, FullHeal: 0b, trainerLocation: 2, oldGen: 0, OldGen: 0, pokeStore: {party1: {EVSpeed: 0s, StatsDefense: 19s, IVAttack: 1b, Growth: 3b, PHiddenAbility: 0b, Moveset: [{MoveID: "Ember", MovePP: 25b}, {MoveID: "Rock Throw", MovePP: 15b}, {MoveID: "Harden", MovePP: 30b}, {MoveID: "Incinerate", MovePP: 15b}], PersistentData: {}, Gender: 0b, GigantamaxFactor: 0b, Friendship: 70s, eggCycles: -1, EVAttack: 0s, StatsSpecialAttack: 30s, IVSpDef: 6b, CaughtBall: "poke_ball", IVHP: 5b, EVHP: 0s, ndex: 218, palette: "none", StatsSpecialDefense: 20s, Nature: 14b, Ability: "FlameBody", StatsHP: 43s, IVDefense: 18b, Health: 43, SpecFlags: [], DoesLevel: 1b, EVDefense: 0s, PAbilitySlot: 1, DynamaxLevel: 0, Variant: "", StatsSpeed: 18s, EVSpecialAttack: 0s, StatsAttack: 19s, IVSpeed: 27b, Level: 18, IVSpAtt: 1b, NBT_VERSION: 2b, EVSpecialDefense: 0s, EXP: 0, RelrnMoves: [], ribbons2: []}, party0: {EVSpeed: 0s, StatsDefense: 27s, IVAttack: 23b, Growth: 2b, PHiddenAbility: 0b, Moveset: [{MoveID: "Stun Spore", MovePP: 30b}, {MoveID: "Leech Seed", MovePP: 10b}, {MoveID: "Mega Drain", MovePP: 15b}, {MoveID: "Headbutt", MovePP: 15b}], PersistentData: {}, Gender: 1b, GigantamaxFactor: 0b, Friendship: 70s, eggCycles: -1, EVAttack: 0s, StatsSpecialAttack: 19s, IVSpDef: 8b, CaughtBall: "poke_ball", IVHP: 0b, EVHP: 0s, ndex: 285, palette: "none", StatsSpecialDefense: 28s, Nature: 2b, Ability: "PoisonHeal", StatsHP: 49s, IVDefense: 6b, Health: 49, SpecFlags: [], DoesLevel: 1b, EVDefense: 0s, PAbilitySlot: 1, DynamaxLevel: 0, Variant: "", StatsSpeed: 19s, EVSpecialAttack: 0s, StatsAttack: 23s, IVSpeed: 13b, Level: 18, IVSpAtt: 2b, NBT_VERSION: 2b, EVSpecialDefense: 0s, EXP: 0, RelrnMoves: [], ribbons2: []}, party2: {EVSpeed: 0s, StatsDefense: 39s, IVAttack: 11b, Growth: 3b, PHiddenAbility: 0b, Moveset: [{MoveID: "Mud-Slap", MovePP: 10b}, {MoveID: "Foresight", MovePP: 40b}, {MoveID: "Mud Bomb", MovePP: 10b}, {MoveID: "Bide", MovePP: 10b}], PersistentData: {}, Gender: 1b, GigantamaxFactor: 0b, Friendship: 70s, eggCycles: -1, EVAttack: 0s, StatsSpecialAttack: 31s, IVSpDef: 4b, CaughtBall: "poke_ball", IVHP: 3b, EVHP: 0s, ndex: 259, palette: "none", StatsSpecialDefense: 33s, Nature: 9b, Ability: "Torrent", StatsHP: 58s, IVDefense: 17b, Health: 58, SpecFlags: [], DoesLevel: 1b, EVDefense: 0s, PAbilitySlot: 0, DynamaxLevel: 0, Variant: "", StatsSpeed: 25s, EVSpecialAttack: 0s, StatsAttack: 36s, IVSpeed: 3b, Level: 20, IVSpAtt: 11b, NBT_VERSION: 2b, EVSpecialDefense: 0s, EXP: 0, RelrnMoves: [], ribbons2: []}, TempPartyEnabled: 0b}, EncMode: 1s, Air: 300s, HandItems: [{}, {}], ArmorDropChances: [0.085f, 0.085f, 0.085f, 0.085f], Profession: -1s, CanPickUpLoot: 0b, HurtTime: 0s, Inventory: [], DefaultWin: 0b, WinMessage: "Yikes! You're better than I expected!", Greeting: "How about a little battle?", Exitable: 1b, TrainerRotation: 0.0f, Encounters: [], FallFlying: 0b, PortalCooldown: 0, TurnTime: 0, DeathTime: 0s, Commands: {winCommands: [], loseCommands: [], preBattleCommands: [], interactCommands: [], forfeitCommands: []}, GymLeader: 0b, EngageDistance: 10, DefaultGreet: 0b, Motion: [0.0d, -0.0784000015258789d, 0.0d], TextureIndex: 4, TrainerIndex: "steve", Health: 20.0f, BattleAIMode: 0s, LoseMessage: "Yay, I win!", LeftHanded: 0b, OnGround: 1b, Rotation: [0.0f, 0.0f], ChatIndex: 0, Fire: -1s, ArmorItems: [{}, {}, {}, {}], CustomSteveTexture: "brendan", NumPokemon: 6, BaseTrainer: "Steve", WinMoney: 800, AIMode: 1s}
execute as @s[scores={DialogueTrigger=58,TalkTime=83,Rival=2,StarterPick=3}] run summon pixelmon:npc_trainer -1419 69 -133 {Brain: {memories: {}}, HurtByTimestamp: 0, NPCLevel: 5, RaiseToCap: 0b, TeamSelectTime: 0, LevelCap: 100, Attributes: [{Base: 0.08d, Name: "forge:entity_gravity"}, {Base: 0.0d, Name: "forge:step_height_addition"}, {Base: 0.699999988079071d, Name: "minecraft:generic.movement_speed"}], BattleType: 0, Invulnerable: 0b, AbsorptionAmount: 0.0f, DefaultLose: 0b, Name: "brendan", FallDistance: 0.0f, WinningsTag: {item0: {id: "minecraft:nether_brick", Count: 1b}}, CanUpdate: 1b, BossTier: "notboss", DefaultName: 1b, hasMegaItem: 0, TeamPreview: 0b, HandDropChances: [0.085f, 0.085f], PersistenceRequired: 1b, FullHeal: 0b, trainerLocation: 2, oldGen: 0, OldGen: 0, pokeStore: {party1: {EVSpeed: 0s, StatsDefense: 18s, IVAttack: 5b, Growth: 2b, PHiddenAbility: 0b, Moveset: [{MoveID: "Water Gun", MovePP: 25b}, {MoveID: "Rollout", MovePP: 20b}, {MoveID: "Whirlpool", MovePP: 15b}, {MoveID: "Astonish", MovePP: 15b}], PersistentData: {}, Gender: 0b, GigantamaxFactor: 0b, Friendship: 70s, eggCycles: -1, EVAttack: 0s, StatsSpecialAttack: 29s, IVSpDef: 3b, CaughtBall: "poke_ball", IVHP: 16b, EVHP: 0s, ndex: 320, palette: "none", StatsSpecialDefense: 19s, Nature: 24b, Ability: "WaterVeil", StatsHP: 77s, IVDefense: 4b, Health: 77, SpecFlags: [], DoesLevel: 1b, EVDefense: 0s, PAbilitySlot: 0, DynamaxLevel: 0, Variant: "", StatsSpeed: 27s, EVSpecialAttack: 0s, StatsAttack: 31s, IVSpeed: 7b, Level: 18, IVSpAtt: 20b, NBT_VERSION: 2b, EVSpecialDefense: 0s, EXP: 0, RelrnMoves: [], ribbons2: []}, party0: {EVSpeed: 0s, StatsDefense: 24s, IVAttack: 14b, Growth: 2b, PHiddenAbility: 0b, Moveset: [{MoveID: "Ember", MovePP: 25b}, {MoveID: "Rock Throw", MovePP: 15b}, {MoveID: "Harden", MovePP: 30b}, {MoveID: "Incinerate", MovePP: 15b}], PersistentData: {}, Gender: 1b, GigantamaxFactor: 0b, Friendship: 70s, eggCycles: -1, EVAttack: 0s, StatsSpecialAttack: 33s, IVSpDef: 26b, CaughtBall: "poke_ball", IVHP: 30b, EVHP: 0s, ndex: 218, palette: "none", StatsSpecialDefense: 24s, Nature: 1b, Ability: "FlameBody", StatsHP: 47s, IVDefense: 26b, Health: 47, SpecFlags: [], DoesLevel: 1b, EVDefense: 0s, PAbilitySlot: 1, DynamaxLevel: 0, Variant: "", StatsSpeed: 15s, EVSpecialAttack: 0s, StatsAttack: 21s, IVSpeed: 17b, Level: 18, IVSpAtt: 21b, NBT_VERSION: 2b, EVSpecialDefense: 0s, EXP: 0, RelrnMoves: [], ribbons2: []}, party2: {EVSpeed: 0s, StatsDefense: 25s, IVAttack: 11b, Growth: 3b, PHiddenAbility: 0b, Moveset: [{MoveID: "Quick Attack", MovePP: 30b}, {MoveID: "Mega Drain", MovePP: 15b}, {MoveID: "Fury Cutter", MovePP: 20b}, {MoveID: "Pursuit", MovePP: 20b}], PersistentData: {}, Gender: 0b, GigantamaxFactor: 0b, Friendship: 70s, eggCycles: -1, EVAttack: 0s, StatsSpecialAttack: 43s, IVSpDef: 10b, CaughtBall: "poke_ball", IVHP: 26b, EVHP: 0s, ndex: 253, palette: "none", StatsSpecialDefense: 33s, Nature: 13b, Ability: "Overgrow", StatsHP: 55s, IVDefense: 13b, Health: 55, SpecFlags: [], DoesLevel: 1b, EVDefense: 0s, PAbilitySlot: 0, DynamaxLevel: 0, Variant: "", StatsSpeed: 50s, EVSpecialAttack: 0s, StatsAttack: 29s, IVSpeed: 18b, Level: 20, IVSpAtt: 21b, NBT_VERSION: 2b, EVSpecialDefense: 0s, EXP: 0, RelrnMoves: [], ribbons2: []}, TempPartyEnabled: 0b}, EncMode: 1s, Air: 300s, HandItems: [{}, {}], ArmorDropChances: [0.085f, 0.085f, 0.085f, 0.085f], Profession: -1s, CanPickUpLoot: 0b, HurtTime: 0s, Inventory: [], DefaultWin: 0b, WinMessage: "Yikes! You're better than I expected!", Greeting: "How about a little battle?", Exitable: 1b, TrainerRotation: 0.0f, Encounters: [], FallFlying: 0b, PortalCooldown: 0, TurnTime: 0, DeathTime: 0s, Commands: {winCommands: [], loseCommands: [], preBattleCommands: [], interactCommands: [], forfeitCommands: []}, GymLeader: 0b, EngageDistance: 10, DefaultGreet: 0b, Motion: [0.0d, -0.0784000015258789d, 0.0d], TextureIndex: 4, TrainerIndex: "steve", Health: 20.0f, BattleAIMode: 0s, LoseMessage: "Yay, I win!", LeftHanded: 0b, OnGround: 1b, Rotation: [0.0f, 0.0f], ChatIndex: 0, Fire: -1s, ArmorItems: [{}, {}, {}, {}], CustomSteveTexture: "brendan", NumPokemon: 6, BaseTrainer: "Steve", WinMoney: 800, AIMode: 1s}


tag @s[scores={DialogueTrigger=58,TalkTime=84..}] add Dialogue58
#-------------------------
#Dialogue 59 - Route 110
#Rival Post-Battle

execute as @s[scores={DialogueTrigger=59}] run clear @s minecraft:nether_brick

tellraw @s[scores={DialogueTrigger=59,TalkTime=3,Rival=1}] ["",{"text":"<May> "},{"selector":"@s"},{"text":", you've been busy training, too, haven't you?"}]
tellraw @s[scores={DialogueTrigger=59,TalkTime=10,Rival=1}] {"text":"<May> Oops! But look at us! Our teams look pretty tired."}
tellraw @s[scores={DialogueTrigger=59,TalkTime=18,Rival=1}] {"text":"<May> Let's get them taken care of first."}

execute as @s[scores={DialogueTrigger=59,TalkTime=25,Rival=1}] run pokeheal
execute as @s[scores={DialogueTrigger=59,TalkTime=25,Rival=1}] run playsound pixelmon:pixelmon.block.healeractivate ambient @s ~ ~ ~ 1 1 1
tellraw @s[scores={DialogueTrigger=59,TalkTime=25,Rival=1}] {"text":"Your team's health was restored!","italic":true,"color":"gray"}

tellraw @s[scores={DialogueTrigger=59,TalkTime=32,Rival=1}] {"text":"<May> And now I think you deserve a reward, too! Here, this is from me!"}

execute as @s[scores={DialogueTrigger=59,TalkTime=40,Rival=1}] run give @s pixelmon:item_finder
execute as @s[scores={DialogueTrigger=59,TalkTime=40,Rival=1}] run playsound keyitem ambient @s ~ ~ ~ 1 1 1
tellraw @s[scores={DialogueTrigger=59,TalkTime=40,Rival=1}] ["",{"selector":"@s","italic":true,"color":"gray"},{"text":" recieved the Dowsing Machine!","italic":true,"color":"gray"}]

tellraw @s[scores={DialogueTrigger=59,TalkTime=47,Rival=1}] {"text":"<May> That's a Dowsing Machine. Try it out—if there's a hidden item anywhere near you, that little thing will react to tell you."}
tellraw @s[scores={DialogueTrigger=59,TalkTime=57,Rival=1}] {"text":"<May> Pay attention, and it'll lead you right to items!"}
tellraw @s[scores={DialogueTrigger=59,TalkTime=64,Rival=1}] {"text":"<May> And it's fun to see all those waving bits above your head."}
tellraw @s[scores={DialogueTrigger=59,TalkTime=71,Rival=1}] {"text":"<May> Try it, and I bet you'll be hooked!"}
tellraw @s[scores={DialogueTrigger=59,TalkTime=78,Rival=1}] ["",{"text":"<May> See you later then, "},{"selector":"@s"},{"text":"! Let's meet again!"}]
tellraw @s[scores={DialogueTrigger=59,TalkTime=86,Rival=1}] {"text":"<May> I hope we'll both be able to meet even more Pokémon on our journeys!"}

#tps May out
execute as @s[scores={DialogueTrigger=59,TalkTime=94,Rival=1}] run particle cloud -1419 69 -133 1 1 1 0.15 300
execute as @s[scores={DialogueTrigger=59,TalkTime=94,Rival=1}] run tp @e[type=pixelmon:npc_trainer,x=-1419,y=68,z=-133,distance=..3] 10000000 -50000 -10000000



tellraw @s[scores={DialogueTrigger=59,TalkTime=3,Rival=2}] ["",{"text":"<Brendan> Sheesh, "},{"selector":"@s"},{"text":", when did you go and train your Pokémon up that well?"}]
tellraw @s[scores={DialogueTrigger=59,TalkTime=12,Rival=2}] {"text":"<Brendan> It's, like, I don't know... It's pretty surprising, OK!"}
tellraw @s[scores={DialogueTrigger=59,TalkTime=20,Rival=2}] {"text":"<Brendan> Both our teams look pretty wiped out after that, huh!"}
tellraw @s[scores={DialogueTrigger=59,TalkTime=27,Rival=2}] {"text":"<Brendan> Here, let me help them out."}

execute as @s[scores={DialogueTrigger=59,TalkTime=34,Rival=2}] run pokeheal
execute as @s[scores={DialogueTrigger=59,TalkTime=34,Rival=2}] run playsound pixelmon:pixelmon.block.healeractivate ambient @s ~ ~ ~ 1 1 1
tellraw @s[scores={DialogueTrigger=59,TalkTime=34,Rival=2}] {"text":"Your team's health was restored!","italic":true,"color":"gray"}

tellraw @s[scores={DialogueTrigger=59,TalkTime=41,Rival=2}] {"text":"<Brendan> And this is for you."}

execute as @s[scores={DialogueTrigger=59,TalkTime=48,Rival=2}] run give @s pixelmon:item_finder
execute as @s[scores={DialogueTrigger=59,TalkTime=48,Rival=2}] run playsound keyitem ambient @s ~ ~ ~ 1 1 1
tellraw @s[scores={DialogueTrigger=59,TalkTime=48,Rival=2}] ["",{"selector":"@s","italic":true,"color":"gray"},{"text":" recieved the Dowsing Machine!","italic":true,"color":"gray"}]

tellraw @s[scores={DialogueTrigger=59,TalkTime=55,Rival=2}] {"text":"<Brendan> That's a Dowsing Machine. Use it to root around for items that aren't visible."}
tellraw @s[scores={DialogueTrigger=59,TalkTime=63,Rival=2}] {"text":"<Brendan> If it senses something nearby, it'll react, see?"}
tellraw @s[scores={DialogueTrigger=59,TalkTime=70,Rival=2}] {"text":"<Brendan> Truth is, once I started using it, I got pretty hooked on it. It's addicting!"}
tellraw @s[scores={DialogueTrigger=59,TalkTime=78,Rival=2}] {"text":"<Brendan> But I recommend you give it a try."}
tellraw @s[scores={DialogueTrigger=59,TalkTime=85,Rival=2}] {"text":"<Brendan> I guess I'm off to get started surveying the next area then."}
tellraw @s[scores={DialogueTrigger=59,TalkTime=92,Rival=2}] ["",{"text":"<Brendan> I hope you meet a lot of Pokémon, too, "},{"selector":"@s"},{"text":"!"}]

#tp Brendan out
execute as @s[scores={DialogueTrigger=59,TalkTime=100,Rival=2}] run particle cloud -1419 69 -133 1 1 1 0.15 300
execute as @s[scores={DialogueTrigger=59,TalkTime=100,Rival=2}] run tp @e[type=pixelmon:npc_trainer,x=-1419,y=68,z=-133,distance=..3] 10000000 -50000 -10000000
...
execute as @s[scores={DialogueTrigger=60,TalkTime=1}] run gamemode spectator
execute as @s[scores={DialogueTrigger=60,TalkTime=1..3}] run tp @s 2710.0 70.5 2920.0 156 30

tellraw @s[scores={DialogueTrigger=60,TalkTime=3}] {"text":"<Wally> Wow! So this is Mauville City!"}

tellraw @s[scores={DialogueTrigger=60,TalkTime=10}] {"text":"<...> Hahaha! You sure seem to be enjoying it, Wally."}
tellraw @s[scores={DialogueTrigger=60,TalkTime=17}] {"text":"<...> So what would you like to do? Do you want to grab a bite to eat at the Mauville Food Court?"}
tellraw @s[scores={DialogueTrigger=60,TalkTime=26}] {"text":"<...> Or maybe we should get you a Bike of your own at Rydel's Cycles."}
tellraw @s[scores={DialogueTrigger=60,TalkTime=33}] {"text":"<...> Would you like that? I bet the exercise would be good for your health."}

tellraw @s[scores={DialogueTrigger=60,TalkTime=40}] {"text":"<Wally> No, thank you! I want to challenge the Gym right away!"}

tellraw @s[scores={DialogueTrigger=60,TalkTime=47}] {"text":"<...> What?"}

tellraw @s[scores={DialogueTrigger=60,TalkTime=54}] {"text":"<Wally> Let me see... I'm pretty sure the Gym is..."}
execute as @s[scores={DialogueTrigger=60,TalkTime=58}] as @e[x=2699,y=64,z=2866,dx=13,dy=5,dz=45,nbt={Name:"Wally"}] run data merge entity @s {Rotation:[180f,0.0f]}
tellraw @s[scores={DialogueTrigger=60,TalkTime=61}] {"text":"<Wally> Yup! Straight ahead this way! Just through the inner courtyard!"}
...
#execute if entity @a[scores={DialogueTrigger=60,TalkTime=78..87}] as @e[x=2699,y=64,z=2866,dx=13,dy=5,dz=45,nbt={Name:"Uncle"}] run data merge entity @s {Motion:[0.0,0.0,-0.35],Rotation:[180f,0.0f]}
#execute if entity @a[scores={DialogueTrigger=60,TalkTime=78..87}] as @e[x=2699,y=64,z=2866,dx=13,dy=5,type=pixelmon:npc_chatting] run tp @s 10000000 -50000 -10000000

tellraw @s[scores={DialogueTrigger=60,TalkTime=70}] {"text":"<...> What? Hey! Wait!"}
execute as @s[scores={DialogueTrigger=60,TalkTime=70}] as @e[x=2699,y=64,z=2866,dx=13,dy=5,dz=45,nbt={Name:"Uncle"}] run data merge entity @s {Rotation:[180f,0.0f]}
tellraw @s[scores={DialogueTrigger=60,TalkTime=77}] {"text":"<...> Wally?!"}

#Other guy tps off

execute as @s[scores={DialogueTrigger=60,TalkTime=85}] run gamemode adventure
execute as @s[scores={DialogueTrigger=60,TalkTime=85}] run tp @s 2705 65 2929 180 10
execute as @s[scores={DialogueTrigger=60,TalkTime=85}] run tp @e[x=2699,y=64,z=2866,dx=13,dy=5,dz=45,type=pixelmon:npc_chatting] 10000000 -50000 -10000000

tag @s[scores={DialogueTrigger=60,TalkTime=85..}] add Dialogue60
#-------------------------------------
