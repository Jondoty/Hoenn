...
#Island Cave
tellraw @s[x=-2853,y=0,z=69,dx=101,dy=30,dz=217] ["",{"text":"Your father's words echo in your mind... ","italic":true,"color":"gray"},{"selector":"@s","italic":true,"color":"gray"},{"text":"! This isn't the time for that!\"","italic":true,"color":"gray"}]
...
tellraw @s[x=546,y=-74,z=83,dx=417,dy=256,dz=251] ["",{"text":"Your father's words echo in your mind... ","italic":true,"color":"gray"},{"selector":"@s","italic":true,"color":"gray"},{"text":"! This isn't the time for that!\"","italic":true,"color":"gray"}]
tag @s[x=546,y=-74,z=83,dx=417,dy=256,dz=251] remove Fly

#Route 134 (Underwater)
tellraw @s[x=265,y=0,z=-3209,dx=198,dy=256,dz=512] ["",{"text":"Your father's words echo in your mind... ","italic":true,"color":"gray"},{"selector":"@s","italic":true,"color":"gray"},{"text":"! This isn't the time for that!\"","italic":true,"color":"gray"}]
