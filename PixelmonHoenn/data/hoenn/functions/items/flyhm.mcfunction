...
tellraw @s[x=2613,y=0,z=2295,dx=149,dy=256,dz=148] {"text":"You cannot use that move here.","italic":true,"color":"gray"}
tag @s[x=2613,y=0,z=2295,dx=149,dy=256,dz=148] remove Fly

#Rusturf Tunnel
tellraw @s[x=-2451,y=0,z=-863,dx=222,dy=60,dz=147] {"text":"You cannot use that move here.","italic":true,"color":"gray"}
tag @s[x=-2451,y=0,z=-863,dx=222,dy=60,dz=147] remove Fly

#Granite Cave
tellraw @s[x=2440,y=0,z=-2673,dx=319,dy=256,dz=387] {"text":"You cannot use that move here.","italic":true,"color":"gray"}
tag @s[x=2440,y=0,z=-2673,dx=319,dy=256,dz=387] remove Fly

#New Mauville
tellraw @s[x=-1399,y=0,z=-413,dx=65,dy=55,dz=92] {"text":"You cannot use that move here.","italic":true,"color":"gray"}
tag @s[x=-1399,y=0,z=-413,dx=65,dy=55,dz=92] remove Fly

#Fiery Path
tellraw @s[x=-1963,y=0,z=-1387,dx=224,dy=60,dz=243] {"text":"You cannot use that move here.","italic":true,"color":"gray"}
tag @s[x=-1963,y=0,z=-1387,dx=224,dy=60,dz=243] remove Fly

#Cave of Origin
tellraw @s[x=1753,y=0,z=-3361,dx=413,dy=256,dz=1075] {"text":"You cannot use that move here.","italic":true,"color":"gray"}
tag @s[x=1753,y=0,z=-3361,dx=413,dy=256,dz=1075] remove Fly

#Scorched Slab
tellraw @s[x=1490,y=0,z=-2562,dx=261,dy=256,dz=276] {"text":"You cannot use that move here.","italic":true,"color":"gray"}
tag @s[x=1490,y=0,z=-2562,dx=261,dy=256,dz=276] remove Fly

#Seafloor Cavern
tellraw @s[x=783,y=0,z=-3361,dx=391,dy=256,dz=797] {"text":"You cannot use that move here.","italic":true,"color":"gray"}
tag @s[x=783,y=0,z=-3361,dx=391,dy=256,dz=797] remove Fly

#Sealed Chamber
tellraw @s[x=2440,y=0,z=-3361,dx=319,dy=256,dz=686] {"text":"You cannot use that move here.","italic":true,"color":"gray"}
tag @s[x=2440,y=0,z=-3361,dx=319,dy=256,dz=686] remove Fly

#Meteor Falls
tellraw @s[x=2168,y=0,z=-3361,dx=270,dy=256,dz=1075] {"text":"You cannot use that move here.","italic":true,"color":"gray"}
tag @s[x=2168,y=0,z=-3361,dx=270,dy=256,dz=1075] remove Fly

#Shoal Cave
tellraw @s[x=2761,y=0,z=-3361,dx=294,dy=256,dz=1075] {"text":"You cannot use that move here.","italic":true,"color":"gray"}
tag @s[x=2761,y=0,z=-3361,dx=294,dy=256,dz=1075] remove Fly

#Mt. Pyre (interior only)
tellraw @s[x=1556,y=23,z=2548,dx=116,dy=55,dz=129] {"text":"You cannot use that move here.","italic":true,"color":"gray"}
tag @s[x=1556,y=23,z=2548,dx=116,dy=55,dz=129] remove Fly

#Victory Road
tellraw @s[x=1176,y=0,z=-3361,dx=575,dy=256,dz=797] {"text":"You cannot use that move here.","italic":true,"color":"gray"}
...
#Ancient Tomb
tellraw @s[x=-428,y=0,z=-1376,dx=116,dy=55,dz=227] {"text":"You cannot use that move here.","italic":true,"color":"gray"}
...
#Team Aqua HQ
tellraw @s[x=1176,y=0,z=-2562,dx=312,dy=256,dz=276] {"text":"You cannot use that move here.","italic":true,"color":"gray"}
tag @s[x=1176,y=0,z=-2562,dx=312,dy=256,dz=276] remove Fly

#Team Magma HQ
tellraw @s[x=783,y=0,z=-2562,dx=391,dy=256,dz=276] {"text":"You cannot use that move here.","italic":true,"color":"gray"}
tag @s[x=783,y=0,z=-2562,dx=391,dy=256,dz=276] remove Fly

#Elite Four
tellraw @s[x=488,y=0,z=-3361,dx=295,dy=256,dz=1075] {"text":"You cannot use that move here.","italic":true,"color":"gray"}
tag @s[x=488,y=0,z=-3361,dx=295,dy=256,dz=1075] remove Fly

#Soaring Overworld
tellraw @s[x=-1048,y=0,z=1331,dx=379,dy=256,dz=296] {"text":"You cannot use that move here.","italic":true,"color":"gray"}
...
#Battle Maison
tellraw @s[x=2348,y=38,z=611,dx=93,dy=40,dz=111] {"text":"You cannot use that move here.","italic":true,"color":"gray"}
