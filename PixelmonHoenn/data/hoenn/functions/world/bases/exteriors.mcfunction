...
#21
execute if entity @e[x=-2070,y=65,z=1410,dy=3,tag=Base21Claimed] if entity @a[x=-2372,y=85,y=-731,distance=50..] run clone -2066 65 1456 -2066 64 1457 -2372 84 -732
execute if entity @e[x=-2070,y=65,z=1410,dy=3,tag=Base21Temp] if entity @a[x=-2372,y=85,y=-731,distance=50..] run clone -2066 65 1456 -2066 64 1457 -2372 84 -732
execute if entity @e[x=-2070,y=65,z=1410,dy=3,tag=!Base21Claimed] if entity @a[x=-2372,y=85,y=-731,distance=50..] run clone -2068 65 1456 -2068 64 1457 -2372 84 -732
